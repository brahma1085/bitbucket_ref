...
import com.sssoft.isatt.data.generated.pojo.QTestplanresult;
...
public class TestPlanResultDaoImpl implements TestPlanResultDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sssoft.isatt.data.dao.output.TestPlanResultDao#getTestPlanResult()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.sssoft.isatt.data.dao.output.TestPlanResultDao#getTestPlanResultById(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.sssoft.isatt.data.dao.output.TestPlanResultDao#insertTestPlanResultGetKey
	 * (com.sssoft.isatt.data.pojo.output.TestPlanResult)
	 */
	@Override

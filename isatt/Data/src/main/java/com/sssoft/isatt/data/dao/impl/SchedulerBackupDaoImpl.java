...
import com.sssoft.isatt.data.generated.pojo.QSchedulerbackup;
...
public class SchedulerBackupDaoImpl implements SchedulerBackupDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sssoft.isatt.data.dao.SchedulerBackupDao#getSchedulerBackup()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sssoft.isatt.data.dao.SchedulerBackupDao#getSchedulerBackupById(int)
	 */
	@Override

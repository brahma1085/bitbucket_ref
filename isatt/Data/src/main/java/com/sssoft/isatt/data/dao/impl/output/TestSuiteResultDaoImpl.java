...
import com.sssoft.isatt.data.generated.pojo.QTestsuiteresult;
...
public class TestSuiteResultDaoImpl implements TestSuiteResultDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sssoft.isatt.data.dao.output.TestSuiteResultDao#getTestSuiteResult()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.sssoft.isatt.data.dao.output.TestSuiteResultDao#getTestSuiteResultById(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.sssoft.isatt.data.dao.output.TestSuiteResultDao#insertTestSuiteResultGetKey

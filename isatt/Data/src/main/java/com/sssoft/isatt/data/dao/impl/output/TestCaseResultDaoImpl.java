...
import com.sssoft.isatt.data.generated.pojo.QTestcaseresult;
...
public class TestCaseResultDaoImpl implements TestCaseResultDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sssoft.isatt.data.dao.output.TestCaseResultDao#getTestCaseResult()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.sssoft.isatt.data.dao.output.TestCaseResultDao#getTestCaseResultById(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.sssoft.isatt.data.dao.output.TestCaseResultDao#insertTestCaseResultGetKey

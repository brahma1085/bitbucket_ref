package com.sssoft.isatt.core.scheduler;
...
import com.sssoft.isatt.core.exception.CoreException;
...
import com.sssoft.isatt.data.pojo.def.LaneListener;
						...
						if (isRunModeSingleVm() && laneListener != null) {
							...
							if (agentDetails == null) {
								...
								if ("http".equalsIgnoreCase(protocol) || "https".equalsIgnoreCase(protocol)) {
									...
									String url = domain + "/Agent/iSATTMulti";

...
/**
 * The Class AddIdentifierTypeController2.
 */
@Controller
public class AddIdentifierTypeController2 {

	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(AddIdentifierTypeController2.class);

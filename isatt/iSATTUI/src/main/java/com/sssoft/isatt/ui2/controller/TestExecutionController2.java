...
/**
 * The Class TestExecutionController2.
 */
@Controller
public class TestExecutionController2 {

	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(TestExecutionController2.class);
	...
	public @ResponseBody
	List<com.sssoft.isatt.data.pojo.Runner> getTestExectionLaneRunType() {
		if (LOG.isDebugEnabled()) {
			LOG.debug("getTestExectionLaneRunType() - start"); //$NON-NLS-1$
		}
		List<com.sssoft.isatt.data.pojo.Runner> returnList = null;
		try {

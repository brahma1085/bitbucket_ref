...
import com.sssoft.isatt.data.pojo.def.ObjectsUI;
...
/**
 * The Class AddParamGroupController2.
 */
@Controller
public class AddParamGroupController2 {

	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(AddParamGroupController2.class);

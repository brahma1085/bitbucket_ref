...
import com.sssoft.isatt.data.excelreader.ReadReplacementStrings;
import com.sssoft.isatt.data.pojo.Scheduler;
import com.sssoft.isatt.data.pojo.def.AgentConfiguration;
import com.sssoft.isatt.data.pojo.def.AgentInterface;
import com.sssoft.isatt.data.pojo.def.AgentRunResult;
import com.sssoft.isatt.data.pojo.def.ReplacementString;
import com.sssoft.isatt.data.pojo.def.RunResult;
...
public class Controller implements AgentInterface {
	...
	/** The url to. */
	private static String urlTo = "http://localhost:8080/iSATT_Core/TestStepGet.jsp";
	...
	/* (non-Javadoc)
	 * @see com.sssoft.isatt.data.pojo.def.AgentInterface#setAgentConfig(com.sssoft.isatt.data.pojo.def.AgentConfiguration)
	 */

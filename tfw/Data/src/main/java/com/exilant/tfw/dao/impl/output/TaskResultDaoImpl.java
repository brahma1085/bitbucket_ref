...
import com.exilant.tfw.generated.pojo.QTaskresult;
...
public class TaskResultDaoImpl implements TaskResultDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.exilant.tfw.dao.output.TaskResultDao#getTaskResult()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.exilant.tfw.dao.output.TaskResultDao#getTaskResultById(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.exilant.tfw.dao.output.TaskResultDao#insertTaskResultGetKey(com.exilant

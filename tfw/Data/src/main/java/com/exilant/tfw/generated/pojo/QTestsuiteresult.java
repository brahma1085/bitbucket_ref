...
public class QTestsuiteresult extends com.mysema.query.sql.RelationalPathBase<QTestsuiteresult> {
    ...
    private static final long serialVersionUID = 1687283146;
    ...
    public final com.mysema.query.sql.ForeignKey<QSchedulerrundetails> testSuiteResultSchedulerRunDetailsFK = createForeignKey(testRunID, "TestRunID");

...
public class PlanSuiteMappingDaoImpl implements PlanSuiteMappingDao {
	 ...
	 * 
	 * @see
	 * com.exilant.tfw.dao.input.PlanSuiteMappingDao#updatePlanSuiteMapping(
	 * com.exilant.tfw.pojo.input.PlanSuiteMapping)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.exilant.tfw.dao.input.PlanSuiteMappingDao#getPlanSuiteIdByPlanIdBySuiteId
	 * (int, int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.exilant.tfw.dao.input.PlanSuiteMappingDao#getPlanSuiteMappingByPlanId
	 * (int)
	 */
	@Override

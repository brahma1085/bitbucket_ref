...
/**
 * The Class AddTestDataControllerITAP.
 */
@Controller
public class AddTestDataControllerITAP {

	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(AddTestDataControllerITAP.class);

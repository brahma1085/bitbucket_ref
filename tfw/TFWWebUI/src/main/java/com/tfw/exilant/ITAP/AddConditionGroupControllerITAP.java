...
/**
 * The Class AddConditionGroupControllerITAP.
 */
@Controller
public class AddConditionGroupControllerITAP {

	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(AddConditionGroupControllerITAP.class);

...
/**
 * The Class AddTestPlanControllerITAP.
 */
@Controller
public class AddTestPlanControllerITAP {

	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(AddTestPlanControllerITAP.class);

...
/**
 * The Class AddTestSuiteControllerITAP.
 */
@Controller
public class AddTestSuiteControllerITAP {

	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(AddTestSuiteControllerITAP.class);

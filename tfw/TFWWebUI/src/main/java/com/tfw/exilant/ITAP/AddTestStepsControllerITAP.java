...
/**
 * The Class AddTestStepsControllerITAP.
 */
@Controller
public class AddTestStepsControllerITAP {

	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(AddTestStepsControllerITAP.class);

...
import com.exilant.tfw.pojo.def.AppFunctionalUI;
import com.exilant.tfw.service.MainService;
import com.exilant.tfw.utils.DataConstants;

/**
 * The Class AddFunctionControllerITAP.
 */
@Controller
public class AddFunctionControllerITAP {

	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(AddFunctionControllerITAP.class);

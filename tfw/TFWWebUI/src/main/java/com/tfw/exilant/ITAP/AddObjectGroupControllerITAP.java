...
/**
 * The Class AddObjectGroupControllerITAP.
 */
@Controller
public class AddObjectGroupControllerITAP {

	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(AddObjectGroupControllerITAP.class);

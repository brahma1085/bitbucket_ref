...
/**
 * The Class CompareJsonRequestValue.
 */
public class CompareJsonRequestValue {
	
	/** Logger for this class. */
	private static final Logger LOG = Logger.getLogger(CompareJsonRequestValue.class);
	...
	public VerifyResult compareRequest(String request, String response, CaptureProps captureProps, VerifyResult verifyResult) {
		...
		if (resTagValue != null && reqTagValue != null) {
			...
			if (resTagValue.equals(reqTagValue)) {
				...
				stringBuffer.append("\n" + reqTagValue + " is present in both request and response. ");
			}

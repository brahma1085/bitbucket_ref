...
<h2 class="h2">Consolidated PayOrder's Report</h2></center></font>
 ...
 function datevalidation(ids){
  ...
  <body class="Mainbody">
    ...
    <font color="red"><%=request.getAttribute("closingmsg")%></font>
     ...
     <html:form action="/FrontCounter/ListPOConsol?pageId=3052" focus="<%=(String)request.getAttribute("FocusTo") %>" >
     	...
     	<br><br><br>
            ...
            <td>Payee Name</td>
            <td>Amount</td>
            <td>Vouchers Consolidated Type/No</td>
            ...
            <td><%=k%></td>
            <td><%=String.valueOf(poObj[i].getPOSerialNo())%></td>

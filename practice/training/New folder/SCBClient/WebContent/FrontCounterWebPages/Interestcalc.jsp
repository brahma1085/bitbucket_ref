...
<html>
  <head><title>AccountOpening</title>
      <h1 style="font:small-caps;font-style:normal;color: blue" ><center>Interest Calculation</center></h1>
...
var ele=document.forms[0].elements;
   ...
   if(ele[i].type=="radio"){
    ...
    alert("Please select All Account or selected account");
    break;
    }
    }
...
<html:select property="acType" styleClass="formTextFieldWithoutTransparent" onblur="Checksubmit()">
    ...
    <table>
 	<tr>
		...
		<td height="38" width="223"><html:text property="acno" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" onblur="submit()"></html:text></td>
	...
	<tr>
		...
		<td height="37" width="223"><html:text property="minibal" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></html:text></td>
	...
	<core:if test="<%=request.getAttribute("enable")!=null%>">
		<td height="35" width="173"><html:submit value="Calculate" onclick="calculate()" styleClass="ButtonBackgroundImage"></html:submit></td>

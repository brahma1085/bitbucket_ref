...
<html>
<head><title>CRR SLR Sub Schedule</title>
      <link href="../Images/DMTStyle.css" rel="stylesheet" type="text/css" /> 
      <h2 class="h2">
      <center>CRR & SLR Sub Schedule</center></h2>
      <hr>
...
if(yymm!=null){
	System.out.println("===========Amzad Substring======"+yymm.substring(0,2));
	System.out.println("===========Amzad Substring======"+yymm.substring(3));
	if(yymm.length()==7){
...
<html:form action="/GL/GLRBICRRSLRSubSchedule?pageId=12030">
<%if(result!=null){ %>
...
<%} %>
 ...
 <html:hidden property="flag"></html:hidden>
   <tr>
    <td><b>Year</b>    
     ...
     <%
      ...
      <b>Month</b>    
      <html:select property="month" onblur="setFlag('from_month')" styleClass="formTextFieldWithoutTransparent">
      <%
      for(int i=01;i<=12;i++){
   ...
   <tr>
   <td>
   Code  <html:select property="code" styleClass="formTextFieldWithoutTransparent">
   <%
   if(codename!=null){

...
<html>
<head><title>Form1 Posting</title>
      <link href="../Images/DMTStyle.css" rel="stylesheet" type="text/css" /> 
      <h2 class="h2">
      <center>Form1 Posting</center></h2>
      <hr>
...
String btnStatus=(String)request.getAttribute("Form1Posting");
String btnStatus1=(String)request.getAttribute("Form1RePosting");
...
<html:form action="/GL/GLForm1Posting?pageId=12040">
<%if(result!=null){ %>
...
<br><br>
 ...
 <html:hidden property="flag"></html:hidden>
   <tr>
    <td>Date    
      <html:text property="fromDate" style="color:blue;font-family:bold" size="10"   onblur="return checkformat(this)" styleClass="formTextFieldWithoutTransparent"></html:text>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<html:text property="toDate" style="color:blue;font-family:bold" size="10"   onblur="return checkformat(this)" styleClass="formTextFieldWithoutTransparent"></html:text><b><font color="red">(dd/mm/yyyy)</font> </b>
    </td>
   </tr>

...
<html>
  ...
  <html:form  action="/TermDeposite/Signature?13030" focus="<%=(String)request.getAttribute("FocusTo") %>">
...
<table border="1" width="372" height="244" >
	...
	<tr>
		...
		<td height="39" width="154"><html:text property="cid" value="<%=String.valueOf(signObject[0].getCid()) %>" readonly="true"></html:text></td>
	...
	<tr>
	 ...
	 -->
	 <!--<tr>
    <td><input type="button" value="SaveSignature" name="method" class="ButtonBackgroundImage" onclick="location.href='?method=SaveSignature'"/></td>
        <td><html:button property="clear" value="Clear" styleClass="ButtonBackgroundImage"></html:button></td>  
	</tr>
--></table>
</core:if>

...
<head><title>Share Allotment</title>
  <link href="../Images/DMTStyle.css" rel="stylesheet" type="text/css" />
    ...
    if(document.forms[0].has_ac.value=="No")
     ...
     else if(document.forms[0].has_ac.value=="Yes"){
      document.getElementById("cidlab").style.display='block';
      document.getElementById("cidtxt").style.display='block'; 
     document.forms[0].gender.value=disabled(true);
            document.forms[0].address.value.readonly=true;
       document.forms[0].rel_ship.value.readonly=true;
       document.forms[0].percentage.value.readonly=true;
       document.forms[0].dob.value.readonly=true;
       document.forms[0].name.value=disabled(true);
    ...
    function hasaccount()
    {
     if(document.getElementById("actype1").value=='Yes'){
...
<html:form action="/Term/Nominee1?pageId=13029">
...
<%if(ac_TYPE!=null){%>  
    <td><bean:message key="label.actype"></bean:message></td>
     ...
     <td><html:text property="actype" styleId="actype1" value="<%=""+ac_TYPE %>"  styleClass="formTextFieldWithoutTransparent" readonly="true"></html:text></td>
      
      <%}else{ %>
      <td><html:text property="actype" styleId="actype1" readonly="true" ></html:text></td>
      <%} %>
    
    
    <td><bean:message key="label.acno"></bean:message></td>
      <%if(shnum!=null){ %>
    <td><html:text property="acno" value="<%=""+shnum %>" onkeyup="numberlimit(this,'5')" styleClass="formTextFieldWithoutTransparent" readonly="true"></html:text></td>
    <%}else{ %>
    <td><html:text property="acno" onkeyup="numberlimit(this,'5')" styleClass="formTextFieldWithoutTransparent" readonly="true"></html:text></td>
    <%} %>
   </tr>
   ...
   <tr>
    ...
    <%if(cusobj!=null){ %> 
    <td><html:text property="name" value="<%=""+cusobj.getName() %>" styleClass="formTextFieldWithoutTransparent" onkeypress="return only_alpha()" readonly="true"></html:text> </td>
    <%}else if(nomObj!=null){%>
    <td><html:text property="name" value="<%=""+nomObj[0].getNomineeName() %>" styleClass="formTextFieldWithoutTransparent" readonly="true"></html:text> </td>
    <%}else { %>
    <td><html:text property="name"  styleClass="formTextFieldWithoutTransparent" onkeypress="return only_alpha()" readonly="true"></html:text> </td>
    <%} %>
   </tr>
   ...
   <tr>
     ...
     <%if(cusobj!=null){ %>
     <td><html:text property="dob" value="<%=""+cusobj.getDOB() %>"readonly="true" styleClass="formTextFieldWithoutTransparent" onkeypress="return only_numbers1()" onkeyup="numberlimit(this,'11')"></html:text> </td>
    <%}else if(nomObj!=null){%>
    <td><html:text property="dob" value="<%=""+nomObj[0].getNomineeDOB() %>" readonly="true" styleClass="formTextFieldWithoutTransparent" onkeypress="return only_numbers1()" onkeyup="numberlimit(this,'11')"></html:text> </td>
    <%}else{ %>
     <td><html:text property="dob" styleClass="formTextFieldWithoutTransparent" onblur="return checkformat(this)" readonly="true" onkeypress="return only_numbers1()" onkeyup="numberlimit(this,'11')"></html:text> </td>
     <%} %>
   </tr>
  ...
  <%}%> 
   ...
   <tr>
    ...
    <%}else{ %>
    <td><html:text property="percentage" styleClass="formTextFieldWithoutTransparent" value="0" onkeypress="return only_numbers()"></html:text></td>
   <%} %>
   </tr>
   ...
   <tr>
    <td>
    <%if(nomineemsg!=null){ %>
     <html:button property="forward"  styleClass="ButtonBackgroundImage" ><bean:message key="label.submit"></bean:message> </html:button>
   		<%}else{ %>
   	<html:button property="forward" styleClass="ButtonBackgroundImage" onclick="set('Submit')"><bean:message key="label.submit"></bean:message> </html:button>	
  		<%} %>
  	 </td>
    <td align="left">

...
%>
<%dep_mast = (DepositMasterObject[])request.getAttribute("misreport");
  
System.out.println("geetha inside misreport..");
%>
<%!
String access;
String  accesspageId;
...
<html:form action="/TermDeposit/MISReport?pageId=13018" >
...
<tr>
				<td>
			     ...
			     <html:text property="process_date" size="12"  onblur="return datevalidation(this)"   onkeypress="return only_numbers_date()" onkeyup="numberlimit(this,'11')" styleClass="formTextFieldWithoutTransparent"></html:text>
			     
			
				<!--
			   		 <bean:message key="label.to_date"></bean:message>
			   	
			    <html:text property="to_date" size="8" value="0"></html:text>
			       --></td>
</tr>
<tr>
...
<display:table name="misreport"  id="currentRowObject" class="its" sort="list" pagesize="500">

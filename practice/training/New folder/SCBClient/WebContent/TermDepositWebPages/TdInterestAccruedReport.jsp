...
<tr>
				<td><font style="font-style: normal;font-size:12px;">
			     ...
			     <html:text property="from_date" size="12"  onblur="return datevalidation(this)"  onkeypress="return only_numbers_date()" styleClass="formTextFieldWithoutTransparent"></html:text>
			     
			
				<font style="font-style: normal;font-size:12px;">
			   		 <bean:message key="label.to_date" ></bean:message></font>
			   	
			    <html:text property="to_date" size="12"  onblur="return datevalidation(this)" onchange="properdate(from_date.value,to_date.value)" onkeypress="return only_numbers_date()"  styleClass="formTextFieldWithoutTransparent" ></html:text>
			       </td>
</tr>
<tr>
...
<display:table name="interestreport" export="true" id="currentRowObject" class="its" sort="list" pagesize="10">

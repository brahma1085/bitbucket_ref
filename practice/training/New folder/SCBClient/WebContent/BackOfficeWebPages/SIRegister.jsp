...
function ValidateForm(){
 ...
 function Validate(){
   var val=document.forms[0].record.value;
   if(val!=0 || val!=""){
     alert(val);
   }
   else{
...
<body class="Mainbody" style="overflow: scroll;" onload="Validate()">
<%! String date;
  SIEntryObject[] sientry;
%>
<% date=(String)request.getAttribute("date");
   String[] insttype=(String[])request.getAttribute("InstructionType");
%>
...
<center><h2 class="h2">Standing Instruction Register</h2></center>
<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
<html:form action="/BackOffice/SIRegister?pageId=11007">
<center>
<table class="txtTable">
 	<tr>
		<td><bean:message key="label.Inst_type"></bean:message>
...
<br><br>
 <table class="txtTable">  
   <tr>
		...
		<html:hidden property="record" styleId="rcdext"/>
...
<center>
<%
  sientry=(SIEntryObject[])request.getAttribute("RegDetails");
   
%>
    
 
   		<div  id = "table1" style="display: block;width: 750px;height: 300px">
   			<display:table name="RegDetails" export="true" id="currentRowObject" class="its" sort="list" pagesize="10" requestURI="/BackOffice/SIRegister.do">
   		...
   		<display:column title="Period_months"  property="periodMonths"      	style="background-color:#F2F0D2"></display:column>
   		<display:column title="Days"           property="periodDays"      	    style="background-color:#F2F0D2"></display:column>
  		...
  		<display:column title="Loan Option"    property="strloanopt"           	style="background-color:#F2F0D2"></display:column>  
   		...
   		<display:column title="Execd Times"    property="execTime"          	style="background-color:#F2F0D2"></display:column>

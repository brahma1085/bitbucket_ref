...
<title>ChequeRegisterPrinting</title>
...
%>
<center><h2 class="h2">List Of ChequeBook Issue Register</h2></center>
<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
<html:form action="/BackOffice/ChequeRegisterPrintingReport?pageId=11004">
<center>
...
>
 	<tr>
		...
		<td><bean:message key="label.to_dt"></bean:message><html:text property="todate" size="10"  onblur="return datevalidation(this)"  onkeypress="return numbersonly_date(this)"  onchange="properdate(fromdate.value,todate.value)" styleClass="formTextFieldWithoutTransparent"></html:text></td>
   </tr>
 </table>
 <br><br>
 <table class="txtTable"
...
<center>
    ...
    <div  id = "table1" style="display: block;width: 750px;height: 300px">
   			<display:table name="ChequeBookDetails" export="true" id="currentRowObject" class="its" sort="list" requestURI="/BackOffice/ChequeRegisterPrintingReport.do" pagesize="10">
   			<display:setProperty name="export.rtf.filename" value="example.rtf"/>
   			<display:column media="csv excel" title="URL" property="url" />
    		<display:setProperty name="export.pdf" value="true" /> 
    
   		<display:column title="Date"        property="requestedDate"   				style="background-color:#F2F0D2"></display:column>
   		<display:column title="chq BookNo"  property="chequeBookNo"    				style="background-color:#F2F0D2"></display:column>
   		<display:column title="Leaves From" property="firstChequeNo"   				style="background-color:#F2F0D2"></display:column>
  		<display:column title="Leaves To"   property="lastChequeNo"          		style="background-color:#F2F0D2"></display:column>
   		<display:column title="AccountType" property="accountType"              	style="background-color:#F2F0D2"></display:column>
   		<display:column title="AccountNo"   property="accountNo"             		style="background-color:#F2F0D2"></display:column>  
   		<display:column title="Name"        property="accountName"           		style="background-color:#F2F0D2"></display:column> 
   		<display:column title="De User"     property="obj_userverifer.userId" 		style="background-color:#F2F0D2"></display:column>
   		<display:column title="De Tml"      property="obj_userverifer.userTml" 		style="background-color:#F2F0D2"></display:column>
   		<display:column title="Ve User"     property="obj_userverifer.verId" 		style="background-color:#F2F0D2"></display:column>
   		<display:column title="Ve Tml"      property="obj_userverifer.verTml" 		style="background-color:#F2F0D2"></display:column>

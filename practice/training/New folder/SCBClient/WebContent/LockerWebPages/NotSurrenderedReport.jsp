...
function set(flagVal)
{
	...
	{
		document.forms[0].validateFlag.value="Enter Valid Date";
	}
...
%>
<center><h2 class="h2">NotSurrenderReport </h2></center>
<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
<html:form action="NotSurrenderedReportLink?pageId=9018">
...
<td><bean:message key="label.date" ></bean:message></td>    <td><html:text property="toDate"  value="<%=(String)request.getAttribute("toDate")%>" onkeyup="numberlimit(this,'11')" onkeypress="return numbersonly_date(this)" styleClass="formTextFieldWithoutTransparent" onblur="return datevalidation(this)"></html:text></td>
</tr>
...
<tr>
	<td> 
	<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
		<html:button property="sub" onclick="set('view')" styleClass="ButtonBackgroundImage"><bean:message key="label.view1"></bean:message></html:button> </td> 
		<%}else{ %>
        <font color="red"><bean:message key="label.accessdenied"></bean:message></font>
        <%} %>
		<td><html:submit property="cle" styleClass="ButtonBackGroundImage"><bean:message key="label.clear"></bean:message></html:submit>  </td>
	<td>
	<td><html:button property="store" styleClass="ButtonBackgroundImage" onclick="storeFile('File')"><bean:message key="label.file"/></html:button></td>	
</tr>
</table>
</td>
</tr>
</table>
<display:table name="details" style="background-color:#E4D5BE" pagesize="8" requestURI="/NotSurrenderedReportLink.do">

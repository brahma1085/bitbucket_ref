...
<center>
  <div  id = "table1" style="display: block;width: 750px;height: 300px">
   			...
   			<display:table name="Report" id="currentRowObject" class="its" sort="list" pagesize="10" requestURI="/Share/ShareRegistrySum.do" >
    ...
    -->
       ...
       <display:column property="branchCode" maxWords="3"></display:column>
       <display:column property="branchName" maxWords="3" ></display:column>

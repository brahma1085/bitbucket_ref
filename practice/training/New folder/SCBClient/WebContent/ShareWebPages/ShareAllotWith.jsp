...
<head><title>Share Registry</title>
      ...
      <h2 class="h2">
      <center>Share Allotment/Withdrawal</center></h2>
      <hr>
...
<html:form action="/Share/ShareAllotwith?pageId=4026">
   <center>
 <table class="txtTable">
 
 <tr>
    <td><bean:message key="label.frm_dt"></bean:message>
     <html:text property="frm_dt" size="10" styleClass="formTextFieldWithoutTransparent"  onkeypress="return numbersonly()" onblur="ValidateForm()" onkeyup="numberlimit(this,'11')"></html:text></td>
 
     <td><bean:message key="label.to_dt"></bean:message> 
     <html:text property="to_dt" size="10" styleClass="formTextFieldWithoutTransparent"  onkeypress="return numbersonly()" onblur="ValidateForm()" onchange="properdate(frm_dt.value,to_dt.value)" onkeyup="numberlimit(this,'11')"></html:text></td> 
  </tr>
...
<td>
    <%if(shreport!=null){ %>
     <jsp:include page="/AllotWithView.jsp"></jsp:include>
 	<%

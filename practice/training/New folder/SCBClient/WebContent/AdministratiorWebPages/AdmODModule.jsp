...
<html>
  <head><title>AccountOpening</title>
      <h1 style="font:small-caps;font-style:normal;color: blue" ><center>OVERDRAW ACCOUNT MODULE</center></h1>
  ...
  <body class="Mainbody">
    ...
    <font color="red"><%=request.getAttribute("closingmsg")%></font>
     ...
     <html:form action="/Administrator/AdmODModule?pageId=10020" focus="<%=(String)request.getAttribute("FocusTo") %>" >

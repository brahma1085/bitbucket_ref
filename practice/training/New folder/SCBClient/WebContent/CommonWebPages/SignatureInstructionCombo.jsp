...
<html>
  ...
  <body>
  		 ...
  		 <%
  			...
  			signObject=(SignatureInstructionObject)request.getAttribute("signInfo1");
       ...
       <html:form action="<%=callPagePath%>">
            				...
            				<table cellspacing="5" style="border-bottom-color:black;border-bottom-style:solid;border-bottom-style:solid;border-left-color:black;border-left-style:solid;border-right-style:solid;border-right-color:black;border-top-color:black;border-top-style:solid;">
				    	        ...
				    	        <tr>
                   					...
                   					<%if(signObject!=null){ %>
                   						<td><html:text property="cid" size="8" onchange="submit()" style="border:none;background:transparent;width:100%" value="<%=""+signObject.getCid()%>" readonly="true"></html:text></td>
                   					<%}else{ %>	
               					...
               					<tr>
                   					...
                   					<%if(signObject!=null) { %>
                   						<td><html:text property="acType"  size="8" onchange="submit()" style="border:none;background:transparent;width:100%" value="<%=""+signObject.getSAccType()%>" readonly="true"></html:text></td>
                   					<%}else{ %>
               					...
               					<tr>
                   					...
                   					<%}else{ %>
                   					<td ><html:text property="acNum" style="border:none;background:transparent;width:100%"  value="<%=""+signObject.getSAccNo() %>" size="8" ></html:text></td>
                   					<% } %>
               					...
               					<tr>
                    				...
                    				<%if(signObject==null){%>
                   					...
                   					<%}else{ %>
                   					<td><html:text property="name" style="border:none;background:transparent;width:100%" value="<%=""+signObject.getName() %>" size="8"></html:text></td>
                   					<%} %>
               					</tr>

            ...
            <table class="txtTable">
                ...
                <tr>
                     <td><bean:message key="label.pygno"></bean:message></td>
                      <core:choose>
                      	 <core:when test="${requestScope.PygmyUpdateDetails!=null}">
                      	 	<td><html:text property="pyg_no" size="10" onchange="submit()" value="${requestScope.PygmyUpdateDetails.accNo}" styleClass="formTextFieldWithoutTransparent" onkeypress=" return numbersOnly()"></html:text></td>
                         </core:when>
                      	 <core:otherwise>
                      	 	<td><html:text property="pyg_no" size="10" onchange="submit()" value="0" styleClass="formTextFieldWithoutTransparent" onkeypress=" return numbersOnly()"></html:text></td>
                         </core:otherwise>	 	
                     </core:choose>
                </tr>
               	...
               	<tr>	
               		...
               		<core:choose>
                      	 <core:when test="${requestScope.PygmyUpdateDetails!=null}">
                      	 	<td><html:text property="cust_id" size="10"  value="${requestScope.PygmyUpdateDetails.cid}" styleClass="formTextFieldWithoutTransparent" onkeypress=" return numbersOnly()" readonly=""></html:text></td>
                         </core:when>
                      	 <core:otherwise>

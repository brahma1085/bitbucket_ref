...
<html>
  <head><title>AccountOpening</title>
      <h1 style="font:small-caps;font-style:normal;color: blue" ><center>FIXED DEPOSIT MODULE</center></h1>
  ...
  <body class="Mainbody">
    ...
    <font color="red"><%=request.getAttribute("closingmsg")%></font>
     ...
     <html:form action="/Administrator/AdmFDModule?pageId=10014" focus="<%=(String)request.getAttribute("FocusTo") %>" >
     ...
     <tr>
     <td>Max No. Of Renewals: </td>
     <td><html:text property="maxrenewal"></html:text> </td>
     </tr>
     <tr>
     <td>Min Deposit Amount: </td>
     <td><html:text property="mindepamount"></html:text> </td>
     </tr>
     ...
     <td><html:text property="maxdepamount"></html:text> </td>
     </tr>
     <tr>
     <td>Max Period: </td>
     <td><html:text property="maxperiod"></html:text> </td>
     </tr>
     <tr>
     ...
     <tr>
     <td>Pre-Mature Penalty Rate: </td>
     <td><html:text property="prematrate"></html:text> </td>
     </tr>
     <tr>
     <td>Last Receipt No.: </td>
     <td><html:text property="lastreceipt"></html:text> </td>
     </tr>
     <tr>
     <td>Int Cal Vch No.: </td>
     <td><html:text property="intcalvchno"></html:text> </td>
     </tr>
     </table>
     <br><br>
     <br><br>

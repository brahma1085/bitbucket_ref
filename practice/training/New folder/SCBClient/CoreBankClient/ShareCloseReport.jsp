...
<html>
<head><title>Share Close Report</title>
     <link href="../Images/DMTStyle.css" rel="stylesheet" type="text/css" />
      <h2 class="h2">
      <center>Share Close Report</center></h2>
      <hr>
...
<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
 <html:form action="/Share/ShareCloseReport?pageId=4021">
   <center>
 <table class="txtTable">
 
  <tr>
    <td><bean:message key="label.frm_dt"></bean:message>
     <html:text property="frm_dt" size="10" styleClass="formTextFieldWithoutTransparent"  onblur="ValidateForm()" onkeypress="return numbersonly()" onkeyup="numberlimit(this,'11')"></html:text></td>
 
     <td><bean:message key="label.to_dt"></bean:message> 
     <html:text property="to_dt" size="10" styleClass="formTextFieldWithoutTransparent"  onblur="ValidateForm()" onchange="properdate(frm_dt.value,to_dt.value)" onkeypress="return numbersonly()" onkeyup="numberlimit(this,'11')"></html:text></td> 
  </tr>

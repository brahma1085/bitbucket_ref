...
<html>
  <head><title>AccountOpening</title>
      <h1 style="font:small-caps;font-style:normal;color: blue" ><center>CLEARING MODULE</center></h1>
  ...
  <body class="Mainbody">
    ...
    <font color="red"><%=request.getAttribute("closingmsg")%></font>
     ...
     <html:form action="/Administrator/AdmClearingModule?pageId=10019" focus="<%=(String)request.getAttribute("FocusTo") %>" >
     ...
     <tr>
     <td>Last Control No.: </td>
     <td><html:text property="lastcontrolno"></html:text> </td>
     </tr>
    <tr>
     <td>OutDated Cheque Validity Period: </td>
     <td><html:text property="outchqvalidperiod"></html:text> </td>
     </tr>
     
     <tr>
     <td>PostDated Cheque Validity Period: </td>
     <td><html:text property="postchqvalidperiod"></html:text> </td>
     </tr>
     <tr>
     <td>Last Acknowledgement No.: </td>
     <td><html:text property="lastackno"></html:text> </td>
     </tr>
     <tr>
     <td>Cheque Validity Period : </td>
     <td><html:text property="chqvalidperiod"></html:text> </td>
     </tr>
     <tr>
     <td>Max No. of Clearing: </td>
     <td><html:text property="maxclearing"></html:text> </td>
     </tr>

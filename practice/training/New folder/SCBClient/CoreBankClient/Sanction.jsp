...
<table class="txtTable">
   <tr>
    ...
    <tr>
       ...
       <td><html:select property="shtype">
              <html:option value="1001001">SH</html:option>
           </html:select>
       	<html:text property="shno" size="5" onblur="submit()" ></html:text></td>
    </tr>
   ...
   <tr>
      <td>
          ...
          <td><html:text styleClass="formTextFieldWithoutTransparent" property="period" size="10" onkeypress="return only_numbers()"  ></html:text>
          <html:text styleClass="formTextFieldWithoutTransparent" property="holiday" size="10" onkeypress="return only_numbers()"  onblur="submit()"></html:text>
      </td>
   </tr>	 
   ...
   <tr>
      <td>
        ...
        <td>  <html:text styleClass="formTextFieldWithoutTransparent" property="intrate" size="10" onkeypress="return only_numbers()"  onblur="submit()"></html:text>
      </td>
   </tr> 
   ...
   <tr>
      <td>
         ...
         <td> <html:text styleClass="formTextFieldWithoutTransparent" property="penalrate" size="10" onkeypress="return only_numbers()"  onblur="submit()"></html:text>
      </td>
   </tr>  
...
<tr>  
    ...
    <%}else { %>  
     	<td>
       	   <html:button styleClass="ButtonBackgroundImage" onclick="return fun_button('Submit')" property="sub">Submit</html:button><!--

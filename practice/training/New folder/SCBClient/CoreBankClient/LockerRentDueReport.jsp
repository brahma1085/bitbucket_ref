...
%>
<center><h2 class="h2"><bean:message key="lable.rentDue"></bean:message></h2></center>
<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
<html:form action="/LockerRentDueReportLink?pageId=9015">
...
<tr>
<td><bean:message key="label.to_dt" ></bean:message></td>    <td><html:text property="fromDate" onkeypress="return only_numbers_date()" onkeyup="numberlimit(this,'11')" styleClass="formTextFieldWithoutTransparent" value="<%=(String)request.getAttribute("toDate")%>" onblur="return datevalidation(this)"></html:text></td>
<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
<tr><td> <html:submit property="view" styleClass="ButtonBackGroundImage"><bean:message key="label.view1"></bean:message></html:submit> </td>
<%}else{ %>
...
<display:table name="details" style="background-color:#E4D5BE" id="currentRowObject" pagesize="8" requestURI="/LockerRentDueReportLink.do" class="its" sort="list">

...
<head><title>Balance Sheet</title>
      ...
      <h2 class="h2">
      <center>Balance Sheet</center></h2>
      <hr>
...
String[][] balsheetReportObj=(String[][])request.getAttribute("MonthlyBalSheetReportData");
...
<html:form action="/GL/GLMonthlyBalanceSheet?pageId=12013">
<%if(result!=null){ %>
...
<%} %>
 ...
 <div id="balancesheet" style="display:block;overflow:scroll;width:700px;height:250px">
 <table border="1" bordercolor="blue">
 <tr><td colspan="5" align="center"><b>Liabilities</b></td><td colspan="5" align="center"><b>Assets</b></td></tr>
 <tr>
 <td><b>As On
 <%
 if(date1!=null){
 ...
 %>
  ...
  <%
 if(balsheetReportObj!=null ){
	 for(int j=0;j<balsheetReportObj.length;j++){%><tr>
	 <%for(int k=0;k<10;k++){	 
%>
 <%if(balsheetReportObj[j][k]!=null){ %>
 
 <td><%=balsheetReportObj[j][k]%>
 </td>
 <%}else{%>
 <td>&nbsp;</td>
 <%}%>

...
if(user_role!=null&&accesspageId!=null){
			if(user_role.get(accesspageId)!=null){
				...
				System.out.println("access-----In OD/CCOpening------>"+access);
			}
...
<core:if test="<%=access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1' %>">
   ...
   <%if(master!=null){
     ...
     <html:form action="/FrontCounter/OdccApplicationdataentry?pageId=3022" focus="<%=(String)request.getAttribute("FocusTo") %>" >
...
<table border="1" width="386" height="76" style="border:thin solid navy" class="txtTable">
	<tr>
		...
		<td height="35" width="145">Account No:</td>
			...
			<html:text property="ac_no" size="10" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" onblur="firstone()"></html:text><core:if test="<%=newac!=null %>"><font color="navy"><%=newac%></font></core:if> </td>
	</tr> 
	</table>
	<br><br>
	...
	<tr>
		...
		<td width="227">
		<html:text property="txt_sh_type" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" onblur="submit()"></html:text>
		</td>
	</tr>
	<tr>
 ...
 <tr id="cash1">
			 ...
			 <td><html:text property="scrollNum" styleClass="formTextFieldWithoutTransparent" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" onblur="submit()"></html:text>	</td> 
 </tr> 
 <tr id="cash2">
    		<td>  Name:</td>
    		 <td><html:text property="rcptname" styleClass="formTextFieldWithoutTransparent" onkeypress="return false;"></html:text>    </td>
  </tr>
 <tr id="cash2">
    		<td>  <bean:message key="label.date"></bean:message></td>
    		 <td><html:text property="date" styleClass="formTextFieldWithoutTransparent" onkeypress="return false;"></html:text>    </td>
  </tr> <tr id="cash3">  		 
    		<td>  <bean:message key="label.amount"></bean:message></td>
    		 <td><html:text property="amount" styleClass="formTextFieldWithoutTransparent" onkeypress="return false;"></html:text>    </td>
</tr>
	...
	<tr>
		...
		<td height="25" width="175"><html:text property="srlno" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></html:text></td>
	</tr>
	<tr>
		<td height="29" width="158">Appln Date:</td>
		<td height="29" width="175"><html:text property="appdate" onblur="return checkformat(this)"></html:text></td>
	</tr>
	<tr>
		<td height="26" width="158">Amount Required</td>
		<td height="26" width="175"><html:text property="loanamount" onblur="submit()"></html:text></td>
	</tr>
	<tr>
	...
	<html:checkbox property="chk1" value="chk1" onclick="countchecks()"></html:checkbox>
		...
		<html:text property="cobor1" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></html:text>
	...
	<html:checkbox property="chk2" value="chk2" onclick="countchecks()"></html:checkbox>
		...
		<html:text property="cobor2" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></html:text>
	...
	<html:checkbox property="chk3" value="chk3" onclick="countchecks()"></html:checkbox>
		...
		<html:text property="cobor3" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></html:text>
	...
	<td style="border:thin solid navy">Business Details:</td>
	 ...
	 <tr>
     	          ...
     	          <td>
     	          <html:text property="businessName" style="font-family:bold;color:blue"></html:text>
     	          </td>
     	       </tr>
     	      <tr>
     	          <td align="center" style="font-family:bold;color:blue">
     	          ...
     	          <td>
     	          <html:textarea property="businessAddr" cols="25" rows="5" style="font-family:bold;color:blue"></html:textarea>
     	          </td>
     	       </tr>
     	       <tr>
     	          <td align="center" style="font-family:bold;color:blue">
     	          ...
     	          <td>
     	          <html:text property="businessNature" style="font-family:bold;color:blue"></html:text>
     	          </td>
     	       </tr>
     	       <tr>
     	          <td align="center" style="font-family:bold;color:blue">
     	          ...
     	          <td>
     	          <html:text property="stockValue" style="font-family:bold;color:blue"></html:text>
     	          </td>
     	       </tr>
     	       <tr>
     	          <td align="center" style="font-family:bold;color:blue">
     	          ...
     	          <td>
     	          <html:text property="goodsType" style="font-family:bold;color:blue"></html:text>
     	          </td>
     	       </tr>
     	       <tr>
     	          <td align="center" style="font-family:bold;color:blue">
     	          ...
     	          <td>
     	          <html:text property="goodsCondition" style="font-family:bold;color:blue"></html:text>
     	          </td>
     	       </tr>
     	       <tr>
     	          <td align="center" style="font-family:bold;color:blue">
     	          ...
     	          <td>
     	          <html:text property="turnover" style="font-family:bold;color:blue"></html:text>
     	          </td>
     	       </tr>
     	       <tr>
     	          <td align="center" style="font-family:bold;color:blue">
     	          ...
     	          <td>
     	          <html:text property="businessPhno" style="font-family:bold;color:blue"></html:text>
     	          </td>
     	       </tr>
     	       <tr>
     	          <td align="center" style="font-family:bold;color:blue">
     	          ...
     	          <td>
     	          <html:text property="busMonthlyIncome" style="font-family:bold;color:blue"></html:text>
     	          </td>
     	        </tr>
     	        <tr>
     	          <td align="center" style="font-family:bold;color:blue">
     	          ...
     	          <td>
     	          <html:text property="busMonthlyExpenditure" style="font-family:bold;color:blue" ></html:text>
     	          </td>
     	        </tr>
     	        <tr>
     	          <td align="center" style="font-family:bold;color:blue">
     	          ...
     	          <td>
     	          <html:text property="busNetMonthlyIncome" style="font-family:bold;color:blue"></html:text>
     	          </td>
     	        </tr>
     	        </core:if>
     	        <core:if test="<%=odaccount!=null %>">

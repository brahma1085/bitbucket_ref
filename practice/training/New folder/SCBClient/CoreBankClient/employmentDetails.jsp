...
System.out.println("Inside JSP EmploymentDetails,jsp");
%>

<html:form action="/FrontCounter/OdccApplication?pageId=3029">

<core:if test="<%=odccmaster!=null %>">
<%incomeObj=odccmaster.getIncomeDetails(); 
System.out.println("odccmaster.getIncomeDetails()[0].getGoodsCondition()====>"+ odccmaster.getIncomeDetails()[0].getGoodsCondition());
%>
<%if(incomeObj!=null&&incomeObj[0]!=null){ %>


 <table name="business" class="txtTable" style="border:thin solid #000000;">
     	    <thead style="font-family:bold;color:blue"><font color="red">Business Details</font></thead>
     	      <tr>
     	      ...
     	      <tr>
     	          ...
     	          <td>
     	          <html:textarea property="businessAddr" cols="25" rows="5" value="<%=incomeObj[0].getAddress() %>" style="font-family:bold;color:blue"></html:textarea>
     	          </td>
     	       </tr>
     	       <tr>
     	          <td align="center" style="font-family:bold;color:blue">

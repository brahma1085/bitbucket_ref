...
<h2 class="h2"><center>PassBook</center></h2>
...
<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
		...
		<table class="txtTable" align="">
			<tr>
				<td><bean:message key="label.pygmyactypeno"/></td>
				<td><html:select  property="pygtype" styleClass="formTextFieldWithoutTransparent">
                 ...
                 <td><font style="font-style:normal;font-size:8px"><html:text property="pygno"  size="10" onchange="set('AccNo')"  onkeyup="numberlimit(this,'11')"></html:text></font></td>
                    
                 <td><bean:message key="label.custid"></bean:message></td>   
                      <core:choose>
                      	 <core:when test="${requestScope.PygmyDetails!=null}">
                      	 	<td><html:text property="cid" size="10" readonly="true" value="<%=""+pygmyMaster.getCid()%>" styleClass="formTextField" onkeypress=" return numbersOnly()"></html:text></td>
                         </core:when>
                      	 <core:otherwise>
                      	 	<td><html:text property="cid" size="10" readonly="true" value="0" styleClass="formTextField" onkeypress=" return numbersOnly()"></html:text></td>
                         </core:otherwise>	 	
                     </core:choose>  
			</tr>
			...
			<tr>
				 <td><bean:message key="label.pygname"></bean:message></td>
				  <core:choose>
                      	 <core:when test="${requestScope.PygmyDetails!=null}">
                      	 	<td><html:text property="pygname" readonly="true"  value="<%=pygmyMaster.getName()%>" styleClass="formTextField"></html:text></td>
                         </core:when>
                      	 <core:otherwise>
                      	 	<td><html:text property="pygname" readonly="true" value="0" styleClass="formTextField"></html:text></td>
                         </core:otherwise>	 	
                     </core:choose> 
					 ...
					 <core:choose>
                      	 <core:when test="${requestScope.PygmyDetails!=null}">
                      	 	<td><html:text property="paymode" size="10" readonly="true" value="<%=pygmyMaster.getPayMode()%>" styleClass="formTextField"></html:text></td>
                         </core:when>
                      	 <core:otherwise>
                      	 	<td><html:text property="paymode" size="10" readonly="true" value="0" styleClass="formTextField"></html:text></td>
                         </core:otherwise>	 	
                     </core:choose> 
             ...
             <tr>
                     ...
                     <core:choose>
                      	 <core:when test="${requestScope.PygmyDetails!=null}">
                      	 	<td><html:text property="agno" size="10" readonly="true" value="<%=""+pygmyMaster.getAgentNo()%>" styleClass="formTextField" onkeypress=" return numbersOnly()"></html:text></td>
                         </core:when>
                      	 <core:otherwise>
                      	 	<td><html:text property="agno" size="10" readonly="true" value="0" styleClass="formTextField" onkeypress=" return numbersOnly()"></html:text></td>
                         </core:otherwise>	 	
                     </core:choose>
                    ...
                    <core:choose>
                      	  <core:when test="${requestScope.PygmyDetails!=null}">
                        	<td><html:text property="agname"  readonly="true" value="<%=pygmyMaster.getAgentName()%>"  styleClass="formTextField"></html:text></td>
                          </core:when> 
                          <core:otherwise> 
                            <td><html:text property="agname" readonly="true"  value="" styleClass="formTextField"></html:text></td>
                          </core:otherwise>	
                      </core:choose>
                      ...
                      <core:choose>
                      	  <core:when test="${requestScope.PygmyDetails!=null}">
                        	<td><html:text property="intrupto" readonly="true" value="<%=pygmyMaster.getLastIntrDate()%>" size="10" styleClass="formTextField"></html:text></td>
                          </core:when> 
                          <core:otherwise> 
                            <td><html:text property="intrupto" size="10" readonly="true" value="0" styleClass="formTextField"></html:text></td>
                          </core:otherwise>	
                      </core:choose> 
             </tr>    
             ...
             <tr>
             	  	...
             	  	<core:choose>
                      	  <core:when test="${requestScope.PygmyDetails!=null}">
                        	<td><html:text property="jt_hlds" readonly="true"  value="<%=""+pygmyMaster.getJointHolders()%>" size="10" styleClass="formTextField"></html:text></td>
                          </core:when> 
                          <core:otherwise> 
                            <td><html:text property="jt_hlds" size="10" readonly="true" value="" styleClass="formTextField"></html:text></td>
                          </core:otherwise>	
                     </core:choose>
                    ...
                    <td><bean:message key="label.loanAvail"></bean:message></td>
             	  	<core:choose>
                      	  <core:when test="${requestScope.PygmyDetails!=null}">
                        	<td><html:text property="loanavail" readonly="true"  value="<%=pygmyMaster.getLnAvailed()%>" size="10" styleClass="formTextField"></html:text></td>
                          </core:when> 
                          <core:otherwise> 
                            <td><html:text property="loanavail" size="10" readonly="true" value="" styleClass="formTextField"></html:text></td>
                          </core:otherwise>	
                     </core:choose>
                     <td><bean:message key="label.status"></bean:message></td>
                     <core:choose>
                      	  <core:when test="${requestScope.PygmyDetails!=null}">
                        	<td><html:text property="status" readonly="true"  value="<%=pygmyMaster.getAccStatus()%>" size="10" styleClass="formTextField"></html:text></td>
                          </core:when> 
                          <core:otherwise> 
                            <td><html:text property="status" size="10" readonly="true" value="" styleClass="formTextField"></html:text></td>
                          </core:otherwise>	
                     </core:choose>
			 ...
			 <tr>
	 				...
	 				<td><html:text property="from_date" size="10" onkeypress="return numbersonly_date(this)"  onblur="return datevalidation(this)"></html:text></td>
	 			
	 				<td><bean:message key="label.to_date"/></td>
	 				<td><html:text property="to_date" size="10" onchange="properdate(from_date.value,to_date.value)" onkeypress="return numbersonly_date(this)"  onblur="return datevalidation(this)"></html:text></td>
	 		  </tr>      
					...
					<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
					<td><html:submit onclick="set('view')" value="View" styleClass="ButtonBackgroundImage">View</html:submit>
             		<%}else{ %>

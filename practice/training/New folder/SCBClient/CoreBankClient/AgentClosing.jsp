...
<style type="text/css" media="all">
    ...
    <h2 class="h2"><center>Agent Closing</center></h2>
...
<body class="Mainbody" onload="checkTable()">
	<%! 	ModuleObject[] array_module=null;
			AgentMasterObject[] agentMaster=null,agclose=null,Agentmaster=null;
...
%>
	...
	Agentmaster=(AgentMasterObject[])request.getAttribute("AgentMaster");
		...
		PygmyMaster=(PygmyMasterObject[])request.getAttribute("AccUnderAgent");
	...
	<html:form action="/Pygmy/AgentClosing?pageid=8010">
		...
		<td>
            <table class="txtTable">
                ...
                <tr>
  				...
  				<display:table name="AccUnderAgent"  id="AccUnderAgent" class="its">

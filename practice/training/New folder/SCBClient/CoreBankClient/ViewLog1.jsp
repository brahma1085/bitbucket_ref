   ...
   <tr>
    <td><bean:message key="label.acType"></bean:message></td>
     ...
     <td><bean:message key="label.acNum"></bean:message>
       <html:text property="shnum" styleClass="formTextFieldWithoutTransparent"  size="6"  onchange="submit()" onkeypress="return numbersonly()" onkeyup="numberlimit(this,'11')"></html:text></td>
   </tr>

...
<html>
<head><title>temporary Shares Report</title>
      <link href="../Images/DMTStyle.css" rel="stylesheet" type="text/css" /> 
      <h2 class="h2">
      <center>Temporary Shares Report</center></h2>
      <hr>
...
<html:form action="/Share/TempShare?pageId=4022">
   <center>
 <table class="txtTable">
 
  <tr>
    <td><bean:message key="label.frm_dt"></bean:message>
     <html:text property="frm_dt" styleClass="formTextFieldWithoutTransparent" size="10"  onblur="ValidateForm()" onkeypress="return numbersonly()" onkeyup="numberlimit(this,'11')"></html:text></td>
 
     <td><bean:message key="label.to_dt"></bean:message> 
     <html:text property="to_dt" styleClass="formTextFieldWithoutTransparent" size="10"  onblur="ValidateForm()" onchange="properdate(frm_dt.value,to_dt.value)" onkeypress="return numbersonly()" onkeyup="numberlimit(this,'11')"></html:text></td> 
  </tr>

...
<title>Open Closed Accounts</title>
...
<style type="text/css" media="all">
    ...
    <h2 class="h2">
      <center>Open Closed Accounts</center></h2>
...
String[] detail;
%>
<%dep_mast = (DepositMasterObject[])request.getAttribute("openclosed");
detail = (String[])request.getAttribute("opendetail");
  
System.out.println("geetha inside open closed accounts..");
%>
<%!
String access;
String  accesspageId;
...
<html:form action="/TermDeposit/OpenClosedAccounts?pageId=13015" >
...
<tr>
               ...
               <td>
                ...
                <bean:message key="label.open_close"></bean:message>
...
<tr>
				<td>
			     ...
			     <html:text property="from_date"  size="12"  styleClass="formTextFieldWithoutTransparent"  onblur="return datevalidation(this)" onkeypress="return only_numbers_date()" onkeyup="numberlimit(this,'11')"></html:text>
			    ...
			    <html:text property="to_date" size="12" styleClass="formTextFieldWithoutTransparent" onblur="return datevalidation(this)" onchange="properdate(from_date.value,to_date.value)" onkeypress="return only_numbers_date()" onkeyup="numberlimit(this,'11')"></html:text>
			       </td>
</tr>
...
<display:table name="openclosed"  id="currentRowObject" class="its" sort="list" requestURI="/TermDeposit/OpenClosedAccounts.do" pagesize="200">
...
<display:column property="depType"  title ="Deposit type"></display:column>
...
<display:column property="autoRenewal" ></display:column>
...
<display:column property="depositAmt" ></display:column>
<display:column property="interestMode" ></display:column>

<display:column property="receiptno" ></display:column>

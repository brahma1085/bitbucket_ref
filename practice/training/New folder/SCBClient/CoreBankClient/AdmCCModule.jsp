...
<html>
  <head><title>AccountOpening</title>
      <h1 style="font:small-caps;font-style:normal;color: blue" ><center>CASH CREDIT MODULE</center></h1>
  ...
  <body class="Mainbody">
    <%!
        ModuleObject[] array_module,mmll;
        String details[];
    ...
    <font color="red"><%=request.getAttribute("closingmsg")%></font>
     ...
     <html:form action="/Administrator/AdmCCModule?pageId=10022" focus="<%=(String)request.getAttribute("FocusTo") %>" >
    ...
    <tr>
     ...
     <tr>
     <td>Share Link %: </td>
     <td><html:text property="sharelp"></html:text> </td>
     </tr>
   <tr>
     <td>Max Sanction Amount: </td>
     <td><html:text property="maxsanction"></html:text> </td>
     </tr>
     <tr>
     ...
     <tr>
     <td>Stock Insp Frequency in months: </td>
     <td><html:text property="stockinsp"></html:text> </td>
     </tr>
     </table>
     <br><br>
     <br><br>

...
<%@page import="masterObject.pygmyDeposit.QuarterInterestObject" %>
<html>
<head>
...
<title>Insert title here</title>
 ...
 <h2 class="h2"><center>Interest Registered Report</center></h2>
...
%>
	...
	<%!
		QuarterInterestObject[] array_obj_pygmyqtrinterest=null;
		String date;
 	 %>
  
  <%
  		array_obj_pygmyqtrinterest=(QuarterInterestObject[])request.getAttribute("InterRegi");
  		System .out.println("m in int regi form------"+array_obj_pygmyqtrinterest);
  ...
  <% String msg=(String)request.getAttribute("msg");
	...
	<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
	 <html:form action="/Pygmy/InterestRegistered?pageid=8004" >
	 <table class="txtTable">
	 	<tr>
	 		<td><bean:message key="label.from_date"/></td>
	 		<td><html:text property="from_dt" size="10" value="<%=date%>"  styleClass="formTextFieldWithoutTransparent" onblur="return datevalidation(this)" onkeypress="return numbersonly_date(this)"></html:text></td>
	 		<td><bean:message key="label.to_date"/>
	 		<html:text property="to_dt" size="10" value="<%=date%>" onchange="properdate(from_dt.value,to_dt.value)" onblur="return datevalidation(this)" onkeypress="return numbersonly_date(this)" styleClass="formTextFieldWithoutTransparent" ></html:text></td>
	 	 </tr>			
	 	     	...
	 	     	<tr>
        			...
        			<%} %>
					<td><html:submit onclick="set('download')" styleClass="ButtonBackgroundImage">DownLoad</html:submit>
	 	...
	 	<%if(array_obj_pygmyqtrinterest!=null){ %>
	 	 
  		<div  id = "table1" style="display: block;overflow:scroll;width: 750px;height: 300px">
   			<display:table name="InterRegi"  id="currentRowObject" class="its" >
   			
  				
  
      				<display:column property="pygmyType" style="background-color:#F2F0D2; font:Garamond " title="Pygmy Type" ></display:column>
            
      				<display:column property="pygmyNo" style="background-color:#F2F0D2 " title="Pygmy No"></display:column>
      
      				<display:column property="intDate" style="background-color:#F2F0D2 " title="Interest Date"></display:column>
      				<display:column property="intAmount" style="background-color:#F2F0D2 " title="Interest Amt"></display:column>
      
      				<display:column property="tml" style="background-color:#F2F0D2 " title="DETml"></display:column>
      				<display:column property="uid" style="background-color:#F2F0D2 " title="DEUser"></display:column>
      				<display:column property="time" style="background-color:#F2F0D2 " title="DE Dt/Time"></display:column>
     			</display:table>
			</div>
     <%} %>

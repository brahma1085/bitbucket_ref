...
<%
System.out.println("Start of the jsp======");
String btnStatus=(String)request.getAttribute("Close");
...
<html:form action="/GL/GLDayClose?pageId=12002">
 ...
 <html:hidden property="flag"></html:hidden>
   ...
   <tr>
     <td>
     <%if(btnStatus!=null){
    	 if(btnStatus.equalsIgnoreCase("NoClose")){
    	 %>
        <html:button property="sub"  disabled="true" styleClass="ButtonBackgroundImage" ><bean:message key="label.close"></bean:message></html:button>
        <%}else{ %>
        <%if(access!=null&&accesspageId!=null&&access.toCharArray()[1]=='1'){%>
        <html:button property="sub1"  onclick="setFlag('submit')" styleClass="ButtonBackgroundImage" ><bean:message key="label.close"></bean:message></html:button>
        <%}else{ %>
        <html:button property="sub1"  onclick="setFlag('submit')" styleClass="ButtonBackgroundImage" disabled="true"><bean:message key="label.close"></bean:message></html:button>
        <%} %>
        <%}
    	 }%>

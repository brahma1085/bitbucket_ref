...
<html>
  <head><title>AccountOpening</title>
      <h1 style="font:small-caps;font-style:normal;color: blue" ><center>CURRENT ACCOUNT MODULE</center></h1>
  ...
  <body class="Mainbody">
    ...
    <font color="red"><%=request.getAttribute("closingmsg")%></font>
     ...
     <html:form action="/Administrator/AdmCAModule?pageId=10018" focus="<%=(String)request.getAttribute("FocusTo") %>" >

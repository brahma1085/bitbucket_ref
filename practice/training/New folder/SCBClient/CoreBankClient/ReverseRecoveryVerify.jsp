...
<html:form action="/Loans/ReverseRecoveryVerify?pageidentity.pageId=5086">
...
<table class="txtTable" cellspacing="5" style="border: thin solid black">
   ...
   <tr>
     ...
     <tr>
							<td>
								...
								<html:select property="creditgl"  disabled="true">
		...
		<%
						...
						<tr>
							...
							<td>
								<html:select property="creditgltype" styleId="gltype" onchange="submit()" disabled="true">
									<%
										if (gl_type != null) {
									%>
									<%
							...
							<td>
								<html:select property="creditglcode" styleId="glcode" onchange="submit()" disabled="true">
									<%
										if (vec_gl_code != null) {
									%>
									<%
						...
						%>
							...
							<td>
								<html:text property="creditgltype" styleId="gltype" size="10" readonly="true" onchange="submit()">
							...
							<td>
								<html:text property="creditglcode" styleId="glcode" size="10" readonly="true" onchange="submit()">
   ...
   <tr>
      ...
      <td align="right"><html:submit property="forward" styleClass="ButtonBackgroundImage" onclick="return set('verify');" value="verify"></html:submit></td>

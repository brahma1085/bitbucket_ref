...
<html>
  <head><title>AccountOpening</title>
      <h1 style="font:small-caps;font-style:normal;color: blue" ><center>PAY ORDER MODULE</center></h1>
  ...
  <body class="Mainbody">
    ...
    <font color="red"><%=request.getAttribute("closingmsg")%></font>
     ...
     <html:form action="/Administrator/AdmPOModule?pageId=10021" focus="<%=(String)request.getAttribute("FocusTo") %>" >
   ...
   <tr>
     <td>Max Amount: </td>
     <td><html:text property="maxamount"></html:text> </td>
     </tr>
     ...
     <td><html:text property="chqvalid"></html:text> </td>
      ...
      <tr>
     <td>Last PO DE No.: </td>
     <td><html:text property="lastpodeno"></html:text> </td>
     </tr>

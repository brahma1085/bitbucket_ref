...
<title>SIDueDone</title>
  <style type="text/css" media="all">
   ...
   function set(target)
       ...
       if(document.getElementById("norecord").value!=null)
       	{
       		if(document.getElementById("norecord").value=="recexist")
		 	{
...
<center><h2 class="h2">Standing Instruction Due/Done Report</h2></center>
...
<html:form action="/BackOffice/SIDueDone?pageId=11008">
<center>
<table class="txtTable">
 	<tr>
		<td><bean:message key="label.Insttype"></bean:message>
			<html:select property="inst_type" >
			<%for(int i=0;i<insttype.length;i++){ %>
			 <html:option value="<%=insttype[i]%>"></html:option>
			<%} %> 
...
<br><br>
 <table class="txtTable">  
   <tr>
	    ...
	    <html:hidden property="valid" styleId="norecord"></html:hidden>
...
<center>
<br>
<%System.out.println("item1=========="+flag); %>
<%
if(flag!=null){
if(flag.equalsIgnoreCase("To Be executed")){ %>

   		<div  id = "table1" style="display: block;width: 750px;height: 300px">
   			<display:table name="DueReport" export="true" id="currentRowObject" class="its" sort="list" pagesize="10" requestURI="/BackOffice/SIDueDone.do">
   			<display:setProperty name="export.rtf.filename" value="example.rtf"/>
   			<display:column media="csv excel" title="URL" property="url" />
    		<display:setProperty name="export.pdf" value="true" /> 

   		
   		<display:column title="Frm A/C"        property="frommodAbbrv"   		style="background-color:#F2F0D2"></display:column>
   		<display:column title="Frm A/C No"     property="fromAccNo"   			style="background-color:#F2F0D2"></display:column>
   		<display:column title="Name"           property="fromaccholdername"   	style="background-color:#F2F0D2"></display:column>
   		...
   		<display:column title="Loan Option"    property="strloanopt"           	style="background-color:#F2F0D2"></display:column>  
   		<display:column title="To A/C"    	   property="tomodAbbrv" 		    style="background-color:#F2F0D2"></display:column>
   		<display:column title="To A/C No "     property="toAccNo" 		        style="background-color:#F2F0D2"></display:column>
   		<display:column title="Name"           property="toaccholdername"   	style="background-color:#F2F0D2"></display:column>
 ...
 <%if(flag.equalsIgnoreCase("Already executed")){ %>

   		<div  id = "table1" style="display: block;width: 750px;height: 300px">
   			<display:table name="DoneReport" export="true" id="currentRowObject" class="its" sort="list" pagesize="10"  requestURI="/BackOffice/SIDueDone.do">
   			<display:setProperty name="export.rtf.filename" value="example.rtf"/>
   			<display:column media="csv excel" title="URL" property="url" />
    		<display:setProperty name="export.pdf" value="true" /> 

   		
   		<display:column title="InstNo"         property="siNo"   				style="background-color:#f5dfc9"></display:column>
   		<display:column title="Frm A/C"        property="frommodAbbrv"   		style="background-color:#f5dfc9"></display:column>
   		<display:column title="Frm A/C No"     property="fromAccNo"   			style="background-color:#f5dfc9"></display:column>
   		<display:column title="Name"           property="fromaccholdername"   	style="background-color:#f5dfc9"></display:column>
   		<display:column title="To A/C"    	   property="tomodAbbrv" 		    style="background-color:#f5dfc9"></display:column>
   		<display:column title="To A/C No "     property="toAccNo" 		        style="background-color:#f5dfc9"></display:column>
   		<display:column title="Name"           property="toaccholdername"   	style="background-color:#f5dfc9"></display:column>
   		<display:column title="Due Date"       property="dueDt"   			    style="background-color:#f5dfc9"></display:column>
   		<display:column title="Amount"         property="trnAmt"          		style="background-color:#f5dfc9"></display:column>
   		<display:column title="Prin"           property="prinAmt"    			style="background-color:#f5dfc9"></display:column>
   		<display:column title="Int"            property="intAmt"      	        style="background-color:#f5dfc9"></display:column>
   		<display:column title="Penal"          property="penalAmt"      	    style="background-color:#f5dfc9"></display:column>
   		<display:column title="Other"          property="otherAmt"      	    style="background-color:#f5dfc9"></display:column>
   		<display:column title="Up to Date"     property="intDt"           	    style="background-color:#f5dfc9"></display:column>  

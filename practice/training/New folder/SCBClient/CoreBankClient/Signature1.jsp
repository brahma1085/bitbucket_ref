...
<html>
  ...
  <html:form  action="/Share/Signature?4041" focus="<%=(String)request.getAttribute("FocusTo") %>">
	...
	<tr>
		...
		if(signObject[0].getPhoto()!=null){
			...
			fos=new FileOutputStream("//root//image.jpg");
				...
				fos.close();
			%>
			<html:img src="//root//image.jpg" height="100" width="100"/>
		<%}%>
	...
	<tr>
		...
		if(signObject[0].getSignature()!=null){
			...
			fos=new FileOutputStream("//root//image1.jpg");
				...
				fos.close();
			%>
			<html:img src="//root//image1.jpg" height="100" width="100"/>
		<%}%>
		</td>
	</tr>
	<tr>

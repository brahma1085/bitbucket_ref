...
<%
 ...
 <br>
  ...
  <div  id = "table1" style="display: block;width: 750px;height: 300px">
   			<display:table name="Report"  id="currentRowObject" class="its" sort="list" pagesize="10" requestURI="/Share/ShareRegistry.do">
       ...
       --><display:column property="check_box"></display:column>
       <display:column property="shareNumber"></display:column>
       
       <display:column property="name"></display:column>
       <display:column property="intrAccno"></display:column>
       ...
       <display:column property="divUptoDate"></display:column>
       <display:column property="loanAvailed"></display:column>
     </display:table>
    </div>

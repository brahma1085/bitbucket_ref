...
<style type="text/css" media="all">
    ...
    <link rel="stylesheet" href="../Images/DMTStyle.css" type="text/css" media="print" />
 	...
 	<h2 class="h2"><center>Register Printing Form</center></h2>
...
function ValidateForm(){
 ...
 function set(target){
       if(document.forms[0].recType.value=="SELECT")
  		{
...
<body class="Mainbody">
  ...
  <%
  		qtr=(QuarterInterestObject[])request.getAttribute("REGIPRINT");
  		recType=(String[])request.getAttribute("RECTYPE");
...
<%if(access!=null&&accesspageId!=null&&access.toCharArray()[0]=='1'){%>
	 <html:form action="/Pygmy/RegisterPrint?pageid=8009">
	 <table class="txtTable">
	 
	 	<tr>
	 		<td><bean:message key="label.recType"/></td>
	 		<td><html:select  property="recType" styleClass="formTextFieldWithoutTransparent">
                     <html:option value="SELECT" >SELECT</html:option>
                      <core:choose>
                        <core:when test="${requestScope.RECTYPE!=null}">
                          <core:forEach var="recType" items="${requestScope.RECTYPE}" varStatus="count">        
                         	
                            <html:option value="${recType}">${recType}</html:option>
	 	...
	 	<tr>
	 	 ...
	 	 <tr>
        		...
        		<font color="red"><bean:message key="label.accessdenied"></bean:message></font>
       			 <%} %>
       			 <html:button property="downloade" onclick="set('save')" styleClass="ButtonBackgroundImage">DownLoad</html:button>
	 	 ...
	 	 <%if (qtr!=null){ %>
	 	  <div  id = "table1" style="display: block;overflow:scroll;width: 750px;height: 300px">
   			<display:table name="REGIPRINT"  id="currentRowObject" class="its" >
   			
  				
  
      				<display:column property="pygmyType" style="background-color:#F2F0D2; font:Garamond;width:100px " title="Pygmy Type" ></display:column>
            
      				<display:column property="pygmyNo" style="background-color:#F2F0D2;width:100px " title="Pygmy No"></display:column>
                    
      				<display:column property="nomName" style="background-color:#F2F0D2;width:100px " title="Nominee Name"></display:column>
      				
      				<display:column property="nomRelation" style="background-color:#F2F0D2;width:100px " title="Nominee Relation"></display:column>
    
      				<display:column property="intDate" style="background-color:#F2F0D2;width:100px " title="Date Of Opening"></display:column>
      				
      				<display:column property="intPdUpto" style="background-color:#F2F0D2;width:100px " title="Int Pd Upto"></display:column>
      				
      				<display:column property="clBal" style="background-color:#F2F0D2;width:100px " title="Closing Bal"></display:column>
     			</display:table>

...
public class ChqWithdrawalForm extends ActionForm {

	String pageId,detailsCombo,acbalance,delet,clicked;
	String tokenno,chqslpo,acType,acno,chqslno,date,amount,payee,setv,hidval,subval;

...
public class PeriodwiseReport extends ActionForm{
	
	String pageId,forward;
	String  process_date,combo_periodyears;
	int srlno;
	String ac_type;
	String but_view,but_query,butt_search,but_file,but_print,but_reprint,but_clear,testing;
	...
	public String getCombo_periodyears() {
		return combo_periodyears;
	}
	public void setCombo_periodyears(String combo_periodyears) {
		this.combo_periodyears = combo_periodyears;
	}

...
public class TDnominee extends ActionForm {
 private String  pageId;
 private String acno,actype,name,dob,gender,address,rel_ship,percentage,forward,issuedate,cid,validations,testing;

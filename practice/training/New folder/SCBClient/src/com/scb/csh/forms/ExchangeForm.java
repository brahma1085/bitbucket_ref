...
String pageId,but_value,exchange,amount,but_sub,closed,send_to,validation,value,upbutton,required,close,error1;
...
double r_coins,p_coins,total,refund,strecamount,rec_amt;
...
//for sub cashier...
int scroll_no,gen_scroll,tr_scroll;
double tr_amount;
...
public int getTr_scroll() {
	return tr_scroll;
}

public void setTr_scroll(int tr_scroll) {
	this.tr_scroll = tr_scroll;
}
...
public String getBut_sub() {
	return but_sub;
}

public void setBut_sub(String but_sub) {
	this.but_sub = but_sub;
}

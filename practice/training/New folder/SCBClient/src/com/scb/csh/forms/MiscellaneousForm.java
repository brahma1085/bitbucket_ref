...
String pageId,glname,narration,denom,flag,gl_code,gl_code1,gl_code2,gl_code3,gl_type,gl_type1,gl_type2,gl_type3,gl_name,but_value,subutton,addbutton,delbutton,delete,value,msClosed,submitfun,updatefun,verifyfun,deletefun,required,cbox,buttton_value;
int scroll_no,gen_scroll,update_scroll,cur_denom;
double amount,total,gl_amount,gl_amount1,gl_amount2,gl_amount3,rec_amt;
...
public double getGl_amount() {
	return gl_amount;
}

public void setGl_amount(double gl_amount) {
	this.gl_amount = gl_amount;
}
...
public String getSubutton() {
	return subutton;
}

public void setSubutton(String subutton) {
...
public String getMsClosed() {
	return msClosed;
}

public void setMsClosed(String msClosed) {
	this.msClosed = msClosed;
}
...
public int getCur_denom() {
	return cur_denom;
}

public void setCur_denom(int cur_denom) {
...
public String getButtton_value() {
	return buttton_value;
}

public void setButtton_value(String buttton_value) {
	this.buttton_value = buttton_value;
}
...
public void setGl_code2(String gl_code2) {
	this.gl_code2 = gl_code2;
}

public String getGl_code3() {
	return gl_code3;
}

public void setGl_code3(String gl_code3) {
	this.gl_code3 = gl_code3;
}

public String getGl_type1() {
	return gl_type1;
}

public void setGl_type1(String gl_type1) {
	this.gl_type1 = gl_type1;
}

public String getGl_type2() {
	return gl_type2;
}

public void setGl_type2(String gl_type2) {
	this.gl_type2 = gl_type2;
}

public String getGl_type3() {
	return gl_type3;
}

public void setGl_type3(String gl_type3) {
	this.gl_type3 = gl_type3;
}

public double getGl_amount1() {
	return gl_amount1;
}

public void setGl_amount1(double gl_amount1) {
	this.gl_amount1 = gl_amount1;
}

public double getGl_amount2() {
	return gl_amount2;
}

public void setGl_amount2(double gl_amount2) {
	this.gl_amount2 = gl_amount2;
}

public double getGl_amount3() {
	return gl_amount3;
}

public void setGl_amount3(double gl_amount3) {
	this.gl_amount3 = gl_amount3;
}

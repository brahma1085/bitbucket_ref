...
public class PaymentForm extends ActionForm{
	...
	String pageId,combo_type,pay_type,dated,pay_name,currency,acc_type,Moduledesc,slip_no,acc_name,validation,paymentfun;
	String nar_name,defaultTab,gl_type,gl_code,gl_name,trn_amt,but_value,dayclose,cashclose,noentry,payment,required;
	String invalid_tkn,cbox,invalid_vcno,inval_vch,inval_amt,value,pay_value,cur_denom;//validation for Joptionpane
	double amount,rec_amt;
	int token_no,acc_no,voucher_no,voucher_no_bk,gen_scroll,update_scroll;
	
	double total,gl_amount;
	...
	public String getNar_name() {
		return nar_name;
	}

	public void setNar_name(String nar_name) {
		this.nar_name = nar_name;
	}

	public String getInvalid_tkn() {
		return invalid_tkn;
	}

	public void setInvalid_tkn(String invalid_tkn) {
		this.invalid_tkn = invalid_tkn;
	}
	...
	public String getInvalid_vcno() {
		return invalid_vcno;
	}

	public void setInvalid_vcno(String invalid_vcno) {
		this.invalid_vcno = invalid_vcno;
	}

	
	public String getInval_vch() {
		return inval_vch;
	}

	public void setInval_vch(String inval_vch) {
		this.inval_vch = inval_vch;
	}
	...
	public int getVoucher_no_bk() {
		return voucher_no_bk;
	}

	public void setVoucher_no_bk(int voucher_no_bk) {
		this.voucher_no_bk = voucher_no_bk;
	}
	...
	public String getInval_amt() {
		return inval_amt;
	}

	public void setInval_amt(String inval_amt) {
		this.inval_amt = inval_amt;
	}
	...
	public String getPaymentfun() {
		return paymentfun;
	}

	public void setPaymentfun(String paymentfun) {
		this.paymentfun = paymentfun;
	}

...
public class LDExcedingMatListForm extends ActionForm {

	private String pageId,txt_fromdate,txt_todate,combo_acctype,button_value,clear,value;
    private String txt_date1,txt_date2,but_print,testing;
    String sysdate;
	...
	public String getTxt_date1() {
		return txt_date1;
	}

	public void setTxt_date1(String txt_date1) {
		this.txt_date1 = txt_date1;
	}

	public String getTxt_date2() {
		return txt_date2;
	}

	public void setTxt_date2(String txt_date2) {
		this.txt_date2 = txt_date2;
	}

...
/**
 * LoanMasterLog entity. @author MyEclipse Persistence Tools
 */

public class LoanMasterLog  implements java.io.Serializable {


    // Fields    

     private LoanMasterLogId id;
    ...
    public LoanMasterLogId getId() {
        return this.id;
    }
    
    public void setId(LoanMasterLogId id) {
        this.id = id;
    }

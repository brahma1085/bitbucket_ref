...
/**
 * ShareRemainderId entity. @author MyEclipse Persistence Tools
 */

public class ShareRemainderId  implements java.io.Serializable {
    ...
    /** default constructor */
    public ShareRemainderId() {
    }

    
    /** full constructor */
    public ShareRemainderId(String acType, Integer acNo, String trnDate, String emailFlag, String smsFlag) {
        this.acType = acType;
        this.acNo = acNo;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ShareRemainderId) ) return false;
		 ShareRemainderId castOther = ( ShareRemainderId ) other; 

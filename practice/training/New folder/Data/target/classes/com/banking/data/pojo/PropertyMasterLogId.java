...
/**
 * PropertyMasterLogId entity. @author MyEclipse Persistence Tools
 */

public class PropertyMasterLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public PropertyMasterLogId() {
    }

    
    /** full constructor */
    public PropertyMasterLogId(Integer acNo, String acType, String propertyNo, String addr, String eastWest, String northSouth, String eastBy, String westBy, String northBy, String southBy, Double marketValue, String propertyAqd, String nature, String tenantName, Double rentMnth, String type) {
        this.acNo = acNo;
        this.acType = acType;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PropertyMasterLogId) ) return false;
		 PropertyMasterLogId castOther = ( PropertyMasterLogId ) other; 

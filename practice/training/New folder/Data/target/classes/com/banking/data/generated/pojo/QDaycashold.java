...
/**
 * QDaycashold is a Querydsl query type for QDaycashold
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDaycashold extends com.mysema.query.sql.RelationalPathBase<QDaycashold> {

    private static final long serialVersionUID = 1618201805;

    public static final QDaycashold daycashold = new QDaycashold("daycashold");
    ...
    public QDaycashold(String variable) {
        super(QDaycashold.class, forVariable(variable), "null", "daycashold");
    }

    @SuppressWarnings("all")
    public QDaycashold(Path<? extends QDaycashold> path) {
        super((Class)path.getType(), path.getMetadata(), "null", "daycashold");
    }

    public QDaycashold(PathMetadata<?> metadata) {
        super(QDaycashold.class, metadata, "null", "daycashold");
    }

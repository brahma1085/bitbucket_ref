...
/**
 * LockerMasterId entity. @author MyEclipse Persistence Tools
 */

public class LockerMasterId  implements java.io.Serializable {
    ...
    /** default constructor */
    public LockerMasterId() {
    }

    
    /** full constructor */
    public LockerMasterId(String acType, Integer acNo) {
        this.acType = acType;
        this.acNo = acNo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LockerMasterId) ) return false;
		 LockerMasterId castOther = ( LockerMasterId ) other; 

...
/**
 * QuantumLimitLogId entity. @author MyEclipse Persistence Tools
 */

public class QuantumLimitLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public QuantumLimitLogId() {
    }

    
    /** full constructor */
    public QuantumLimitLogId(Integer modTy, Integer srlNo, String lmtHdg, Integer frLmt, Integer toLmt, String deTml, String deUser, String deDate, String deTime, String backup) {
        this.modTy = modTy;
        this.srlNo = srlNo;
        this.lmtHdg = lmtHdg;
        this.frLmt = frLmt;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof QuantumLimitLogId) ) return false;
		 QuantumLimitLogId castOther = ( QuantumLimitLogId ) other; 

...
/**
 * DailyConsolidationId entity. @author MyEclipse Persistence Tools
 */

public class DailyConsolidationId  implements java.io.Serializable {
    ...
    /** default constructor */
    public DailyConsolidationId() {
    }

    
    /** full constructor */
    public DailyConsolidationId(Integer brCode, Date trnDt, String glType, Integer glCode, Double cashDr, Double cgDr, Double trfDr, Double cashCr, Double cgCr, Double trfCr, String deTml, String deUser, Timestamp deDateTime, String veTml, String veUser, Timestamp veDateTime) {
        this.brCode = brCode;
        this.trnDt = trnDt;
        this.glType = glType;
        this.glCode = glCode;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DailyConsolidationId) ) return false;
		 DailyConsolidationId castOther = ( DailyConsolidationId ) other; 

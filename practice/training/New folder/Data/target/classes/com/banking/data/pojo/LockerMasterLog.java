...
/**
 * LockerMasterLog entity. @author MyEclipse Persistence Tools
 */

public class LockerMasterLog  implements java.io.Serializable {


    // Fields    

     private LockerMasterLogId id;
     private Integer cid;
    ...
    public LockerMasterLogId getId() {
        return this.id;
    }
    
    public void setId(LockerMasterLogId id) {
        this.id = id;
    }

...
/**
 * PeriodLimitId entity. @author MyEclipse Persistence Tools
 */

public class PeriodLimitId  implements java.io.Serializable {
    ...
    /** default constructor */
    public PeriodLimitId() {
    }

    
    /** full constructor */
    public PeriodLimitId(Integer modTy, Integer srlNo, String lmtHdg, Integer frLmt, Integer toLmt, String deTml, String deUser, String deDate, String deTime, String backup) {
        this.modTy = modTy;
        this.srlNo = srlNo;
        this.lmtHdg = lmtHdg;
        this.frLmt = frLmt;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PeriodLimitId) ) return false;
		 PeriodLimitId castOther = ( PeriodLimitId ) other; 

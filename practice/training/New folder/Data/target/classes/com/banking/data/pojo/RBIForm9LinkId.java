...
/**
 * RBIForm9LinkId entity. @author MyEclipse Persistence Tools
 */

public class RBIForm9LinkId  implements java.io.Serializable {
    ...
    /** default constructor */
    public RBIForm9LinkId() {
    }

    
    /** full constructor */
    public RBIForm9LinkId(Integer code, String trnSrc, String glType, Integer glCode, Date fromdate, Date todate, Double percentage, String cdInd, Integer mulBy, Integer sequence, String deTml, String deUser, Timestamp deDtTime) {
        this.code = code;
        this.trnSrc = trnSrc;
        this.glType = glType;
        this.glCode = glCode;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof RBIForm9LinkId) ) return false;
		 RBIForm9LinkId castOther = ( RBIForm9LinkId ) other; 

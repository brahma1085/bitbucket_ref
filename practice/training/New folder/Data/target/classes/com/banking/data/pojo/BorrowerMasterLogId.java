...
/**
 * BorrowerMasterLogId entity. @author MyEclipse Persistence Tools
 */

public class BorrowerMasterLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public BorrowerMasterLogId() {
    }

    
    /** full constructor */
    public BorrowerMasterLogId(String lnAcType, Integer lnAcNo, String type, String acType, Integer acNo, String brCode) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BorrowerMasterLogId) ) return false;
		 BorrowerMasterLogId castOther = ( BorrowerMasterLogId ) other; 

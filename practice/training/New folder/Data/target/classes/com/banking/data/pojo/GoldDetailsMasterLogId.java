...
/**
 * GoldDetailsMasterLogId entity. @author MyEclipse Persistence Tools
 */

public class GoldDetailsMasterLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public GoldDetailsMasterLogId() {
    }

    
    /** full constructor */
    public GoldDetailsMasterLogId(Integer acNo, String acType, Integer appcode, Integer srlNo, String descr, Double grwgt, Double netwgt, Double rate, String date, String time) {
        this.acNo = acNo;
        this.acType = acType;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof GoldDetailsMasterLogId) ) return false;
		 GoldDetailsMasterLogId castOther = ( GoldDetailsMasterLogId ) other; 

...
/**
 * PeriodLimitLogId entity. @author MyEclipse Persistence Tools
 */

public class PeriodLimitLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public PeriodLimitLogId() {
    }

    
    /** full constructor */
    public PeriodLimitLogId(Integer modTy, Integer srlNo, String lmtHdg, Integer frLmt, Integer toLmt, String deTml, String deUser, String deDate, String deTime, String backup) {
        this.modTy = modTy;
        this.srlNo = srlNo;
        this.lmtHdg = lmtHdg;
        this.frLmt = frLmt;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PeriodLimitLogId) ) return false;
		 PeriodLimitLogId castOther = ( PeriodLimitLogId ) other; 

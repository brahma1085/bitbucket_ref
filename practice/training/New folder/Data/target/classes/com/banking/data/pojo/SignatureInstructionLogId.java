...
/**
 * SignatureInstructionLogId entity. @author MyEclipse Persistence Tools
 */

public class SignatureInstructionLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public SignatureInstructionLogId() {
    }

    
    /** full constructor */
    public SignatureInstructionLogId(String acType, Integer acNo, Integer cid, String name, String desg, Integer minlmt, Integer maxlmt, String typeofopr) {
        this.acType = acType;
        this.acNo = acNo;
        this.cid = cid;
        this.name = name;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SignatureInstructionLogId) ) return false;
		 SignatureInstructionLogId castOther = ( SignatureInstructionLogId ) other; 

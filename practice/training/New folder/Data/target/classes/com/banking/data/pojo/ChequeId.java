...
/**
 * ChequeId entity. @author MyEclipse Persistence Tools
 */
...
public class ChequeId  implements java.io.Serializable {
	...
	/** minimal constructor */
    public ChequeId(Integer ctrlNo) {
        this.ctrlNo = ctrlNo;
    }
    
    /** full constructor */
    public ChequeId(String clgDate, Integer clgNo, Integer sendTo, Integer ctrlNo, String trnType, String clgType, Integer ackNo, Integer docSou, Integer docDest, String docBs, Integer noDocs, Double docTot, String multCr, String compName, String chqddpo, Integer qdpNo, String qdpDt, String retNorm, Integer prevCtrlNo, String trfType, String crAcType, Integer crAcNo, Double poComm, String drAcType, Integer drAcNo, String payeeName, String bankCd, String brName, Double trnAmt, String toBounce, String despInd, String postInd, String discInd, Double discAmt, Double discChg, String expClgdt, Integer expClgno, String letSent, Double mchgAmt, Double fineAmt, String loanAcType, Integer loanAcNo, String deTml, String deUser, String deDtTime, String veTml, String veUser, String veDtTime) {
    ...
    public Double getPoComm() {
        return this.poComm;
    }
    
    public void setPoComm(Double poComm) {
        this.poComm = poComm;
    }

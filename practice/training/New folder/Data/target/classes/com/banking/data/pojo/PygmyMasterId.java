...
/**
 * PygmyMasterId entity. @author MyEclipse Persistence Tools
 */

public class PygmyMasterId  implements java.io.Serializable {
    ...
    /** default constructor */
    public PygmyMasterId() {
    }

    
    /** full constructor */
    public PygmyMasterId(String acType, Integer acNo) {
        this.acType = acType;
        this.acNo = acNo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PygmyMasterId) ) return false;
		 PygmyMasterId castOther = ( PygmyMasterId ) other; 

...
/**
 * RelativeMasterLogId entity. @author MyEclipse Persistence Tools
 */

public class RelativeMasterLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public RelativeMasterLogId() {
    }

    
    /** full constructor */
    public RelativeMasterLogId(String acType, Integer acNo, String reltype, String name, String age, String sex, String marital, String status, String relation) {
        this.acType = acType;
        this.acNo = acNo;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof RelativeMasterLogId) ) return false;
		 RelativeMasterLogId castOther = ( RelativeMasterLogId ) other; 

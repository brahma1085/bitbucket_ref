...
/**
 * LoanMasterLogId entity. @author MyEclipse Persistence Tools
 */

public class LoanMasterLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public LoanMasterLogId() {
    }

    
    /** full constructor */
    public LoanMasterLogId(String acType, Integer acNo) {
        this.acType = acType;
        this.acNo = acNo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LoanMasterLogId) ) return false;
		 LoanMasterLogId castOther = ( LoanMasterLogId ) other; 

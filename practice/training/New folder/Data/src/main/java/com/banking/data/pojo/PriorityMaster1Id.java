...
/**
 * PriorityMaster1Id entity. @author MyEclipse Persistence Tools
 */

public class PriorityMaster1Id  implements java.io.Serializable {
    ...
    /** default constructor */
    public PriorityMaster1Id() {
    }

	/** minimal constructor */
    public PriorityMaster1Id(Integer prCode) {
        this.prCode = prCode;
    }
    
    /** full constructor */
    public PriorityMaster1Id(Integer prCode, String prDesc, String deTml, String deUser, String deDate) {
        this.prCode = prCode;
        this.prDesc = prDesc;
        this.deTml = deTml;
        this.deUser = deUser;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PriorityMaster1Id) ) return false;
		 PriorityMaster1Id castOther = ( PriorityMaster1Id ) other; 

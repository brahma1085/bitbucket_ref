...
/**
 * ChequeOldId entity. @author MyEclipse Persistence Tools
 */

public class ChequeOldId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ChequeOldId) ) return false;
		 ChequeOldId castOther = ( ChequeOldId ) other; 

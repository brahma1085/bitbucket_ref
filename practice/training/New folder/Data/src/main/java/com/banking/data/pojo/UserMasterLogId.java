...
/**
 * UserMasterLogId entity. @author MyEclipse Persistence Tools
 */

public class UserMasterLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public UserMasterLogId() {
    }

    
    /** full constructor */
    public UserMasterLogId(String userId, Integer cid, String password, String shortName, Integer pwdExpiryPeriod, String pwdExpiryDate, String thumpIpm, String operativeFromDate, String operativeToDate, Integer disable, String deTml, String deUser, String deDate) {
        this.userId = userId;
        this.cid = cid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof UserMasterLogId) ) return false;
		 UserMasterLogId castOther = ( UserMasterLogId ) other; 

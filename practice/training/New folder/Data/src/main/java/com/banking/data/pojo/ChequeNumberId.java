...
/**
 * ChequeNumberId entity. @author MyEclipse Persistence Tools
 */

public class ChequeNumberId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ChequeNumberId) ) return false;
		 ChequeNumberId castOther = ( ChequeNumberId ) other; 

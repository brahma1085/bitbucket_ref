...
/**
 * QChequelog is a Querydsl query type for QChequelog
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QChequelog extends com.mysema.query.sql.RelationalPathBase<QChequelog> {

    private static final long serialVersionUID = 1023085838;

    public static final QChequelog chequelog = new QChequelog("chequelog");
    ...
    public final NumberPath<Float> poComm = createNumber("po_comm", Float.class);
    ...
    public QChequelog(String variable) {
        super(QChequelog.class, forVariable(variable), "null", "chequelog");
    }

    @SuppressWarnings("all")
    public QChequelog(Path<? extends QChequelog> path) {
        super((Class)path.getType(), path.getMetadata(), "null", "chequelog");
    }

    public QChequelog(PathMetadata<?> metadata) {
        super(QChequelog.class, metadata, "null", "chequelog");
    }

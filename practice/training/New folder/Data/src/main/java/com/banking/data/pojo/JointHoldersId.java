...
/**
 * JointHoldersId entity. @author MyEclipse Persistence Tools
 */

public class JointHoldersId  implements java.io.Serializable {
    ...
    /** default constructor */
    public JointHoldersId() {
    }

    
    /** full constructor */
    public JointHoldersId(String acType, Integer acNo, Integer cid, Integer addrType) {
        this.acType = acType;
        this.acNo = acNo;
        this.cid = cid;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof JointHoldersId) ) return false;
		 JointHoldersId castOther = ( JointHoldersId ) other; 

...
/**
 * DepositMasterTempId entity. @author MyEclipse Persistence Tools
 */

public class DepositMasterTempId  implements java.io.Serializable {
    ...
    /** default constructor */
    public DepositMasterTempId() {
    }

    
    /** full constructor */
    public DepositMasterTempId(String trnDate, String glType, Integer glCode, String trnMode, Double trnAmt, String cdInd, String refAcType, Integer refAcNo, Integer refTrSeq, String refTrType, Integer refNo, String veTml, String veUser, String veDate) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DepositMasterTempId) ) return false;
		 DepositMasterTempId castOther = ( DepositMasterTempId ) other; 

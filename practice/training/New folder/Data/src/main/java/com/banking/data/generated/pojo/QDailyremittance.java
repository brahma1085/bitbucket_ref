...
/**
 * QDailyremittance is a Querydsl query type for QDailyremittance
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDailyremittance extends com.mysema.query.sql.RelationalPathBase<QDailyremittance> {

    private static final long serialVersionUID = -1095860798;

    public static final QDailyremittance dailyremittance = new QDailyremittance("dailyremittance");
    ...
    public QDailyremittance(String variable) {
        super(QDailyremittance.class, forVariable(variable), "null", "dailyremittance");
    }

    @SuppressWarnings("all")
    public QDailyremittance(Path<? extends QDailyremittance> path) {
        super((Class)path.getType(), path.getMetadata(), "null", "dailyremittance");
    }

    public QDailyremittance(PathMetadata<?> metadata) {
        super(QDailyremittance.class, metadata, "null", "dailyremittance");
    }

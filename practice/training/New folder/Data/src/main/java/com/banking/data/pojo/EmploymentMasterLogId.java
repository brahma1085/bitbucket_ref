...
/**
 * EmploymentMasterLogId entity. @author MyEclipse Persistence Tools
 */

public class EmploymentMasterLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public EmploymentMasterLogId() {
    }

    
    /** full constructor */
    public EmploymentMasterLogId(Integer acNo, String acType, String empType, String concernName, String natureOfEmp, String employerName, String addr, Integer phNo, String empNo, String designation, String department, Integer servLength, String empConfirmed, String servTrans, String salCertEnclosed, Double amtMnth, Double taxExpMnth, String bankName, String bankAcType, Integer bankAcNo, Double stockVal, String goodsCond, String goodsType, Double avgTurnoverMnth, Double netMonthIncome) {
        this.acNo = acNo;
        this.acType = acType;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof EmploymentMasterLogId) ) return false;
		 EmploymentMasterLogId castOther = ( EmploymentMasterLogId ) other; 

...
/**
 * CustomerAddressLogId entity. @author MyEclipse Persistence Tools
 */

public class CustomerAddressLogId  implements java.io.Serializable {
    ...
    /** default constructor */
    public CustomerAddressLogId() {
    }

	/** minimal constructor */
    public CustomerAddressLogId(Integer addrType) {
        this.addrType = addrType;
    }
    
    /** full constructor */
    public CustomerAddressLogId(Integer cid, Integer addrType, String udate, String address, String city, String state, Integer pin, String country, Integer phno, Integer phstd, Integer fax, Integer faxstd, Integer mobile, String email, String deUser, String deTml, String deDate) {
        this.cid = cid;
        this.addrType = addrType;
        this.udate = udate;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CustomerAddressLogId) ) return false;
		 CustomerAddressLogId castOther = ( CustomerAddressLogId ) other; 

...
/**
 * LoanMasterId entity. @author MyEclipse Persistence Tools
 */

public class LoanMasterId  implements java.io.Serializable {
    ...
    /** full constructor */
    public LoanMasterId(String acType, Integer acNo) {
        this.acType = acType;
        this.acNo = acNo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LoanMasterId) ) return false;
		 LoanMasterId castOther = ( LoanMasterId ) other; 

...
/**
 * PayOrderLog entity. @author MyEclipse Persistence Tools
 */

public class PayOrderLog  implements java.io.Serializable {
    ...
    /** full constructor */
    public PayOrderLog(String payordDt, String cdInd, String payeeNm, Double trnAmt, String poCancel, String poStop, Integer poPrtInd, Integer poCshInd, Integer poChqNo, String validUpto, String poCshDt, String deTml, String deUser, String deDate, String veTml, String veUser, String veDate, Integer poEncshRefNo) {

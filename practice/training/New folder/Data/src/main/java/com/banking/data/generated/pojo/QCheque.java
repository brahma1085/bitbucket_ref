...
public class QCheque extends com.mysema.query.sql.RelationalPathBase<QCheque> {

    private static final long serialVersionUID = 557972086;
    ...
    public QCheque(String variable) {
        super(QCheque.class, forVariable(variable), "null", "cheque");
    }

    @SuppressWarnings("all")
    public QCheque(Path<? extends QCheque> path) {
        super((Class)path.getType(), path.getMetadata(), "null", "cheque");
    }

    public QCheque(PathMetadata<?> metadata) {
        super(QCheque.class, metadata, "null", "cheque");
    }

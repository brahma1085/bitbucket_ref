...
/**
 * DepositMasterId entity. @author MyEclipse Persistence Tools
 */

public class DepositMasterId  implements java.io.Serializable {
    ...
    /** default constructor */
    public DepositMasterId() {
    }

    
    /** full constructor */
    public DepositMasterId(String acType, Integer acNo) {
        this.acType = acType;
        this.acNo = acNo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DepositMasterId) ) return false;
		 DepositMasterId castOther = ( DepositMasterId ) other; 

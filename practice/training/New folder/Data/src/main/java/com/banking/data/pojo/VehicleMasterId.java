...
/**
 * VehicleMasterId entity. @author MyEclipse Persistence Tools
 */

public class VehicleMasterId  implements java.io.Serializable {
    ...
    /** default constructor */
    public VehicleMasterId() {
    }

    
    /** full constructor */
    public VehicleMasterId(String acType, Integer acNo, String make, Double cost, String addrdealer, String licno, String validity, String type, String permitno, String pvalidity, String vehfor, String area, String addrpark, String other) {
        this.acType = acType;
        this.acNo = acNo;
        this.make = make;
        this.cost = cost;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VehicleMasterId) ) return false;
		 VehicleMasterId castOther = ( VehicleMasterId ) other; 

...
/**
 * QSharemaster is a Querydsl query type for QSharemaster
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QSharemaster extends com.mysema.query.sql.RelationalPathBase<QSharemaster> {

    private static final long serialVersionUID = 238074828;

    public static final QSharemaster sharemaster = new QSharemaster("sharemaster");
    ...
    public final com.mysema.query.sql.PrimaryKey<QSharemaster> primary = createPrimaryKey(acNo, acType, tempNo);

    public QSharemaster(String variable) {
        super(QSharemaster.class, forVariable(variable), "null", "sharemaster");
    }

    @SuppressWarnings("all")
    public QSharemaster(Path<? extends QSharemaster> path) {
        super((Class)path.getType(), path.getMetadata(), "null", "sharemaster");
    }

    public QSharemaster(PathMetadata<?> metadata) {
        super(QSharemaster.class, metadata, "null", "sharemaster");
    }

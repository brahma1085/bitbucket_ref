...
/**
 * QLoanmasterlog is a Querydsl query type for QLoanmasterlog
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QLoanmasterlog extends com.mysema.query.sql.RelationalPathBase<QLoanmasterlog> {

    private static final long serialVersionUID = -1598133059;

    public static final QLoanmasterlog loanmasterlog = new QLoanmasterlog("loanmasterlog");
    ...
    public final com.mysema.query.sql.PrimaryKey<QLoanmasterlog> primary = createPrimaryKey(acNo, acType);

    public QLoanmasterlog(String variable) {
        super(QLoanmasterlog.class, forVariable(variable), "null", "loanmasterlog");
    }

    @SuppressWarnings("all")
    public QLoanmasterlog(Path<? extends QLoanmasterlog> path) {
        super((Class)path.getType(), path.getMetadata(), "null", "loanmasterlog");
    }

    public QLoanmasterlog(PathMetadata<?> metadata) {
        super(QLoanmasterlog.class, metadata, "null", "loanmasterlog");
    }

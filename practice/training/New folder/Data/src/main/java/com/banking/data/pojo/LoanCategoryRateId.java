...
/**
 * LoanCategoryRateId entity. @author MyEclipse Persistence Tools
 */

public class LoanCategoryRateId  implements java.io.Serializable {
    ...
    /** default constructor */
    public LoanCategoryRateId() {
    }

    
    /** full constructor */
    public LoanCategoryRateId(String lnType, String dateFr, String dateTo, Integer category, Double rate, String deTml, String deUser, String deDtTime) {
        this.lnType = lnType;
        this.dateFr = dateFr;
        this.dateTo = dateTo;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof LoanCategoryRateId) ) return false;
		 LoanCategoryRateId castOther = ( LoanCategoryRateId ) other; 

...
/**
 * QDepositmasterlog is a Querydsl query type for QDepositmasterlog
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QDepositmasterlog extends com.mysema.query.sql.RelationalPathBase<QDepositmasterlog> {

    private static final long serialVersionUID = -376659239;

    public static final QDepositmasterlog depositmasterlog = new QDepositmasterlog("depositmasterlog");
    ...
    public final StringPath lstPrDate = createString("lst_pr_date");
    ...
    public QDepositmasterlog(String variable) {
        super(QDepositmasterlog.class, forVariable(variable), "null", "depositmasterlog");
    }

    @SuppressWarnings("all")
    public QDepositmasterlog(Path<? extends QDepositmasterlog> path) {
        super((Class)path.getType(), path.getMetadata(), "null", "depositmasterlog");
    }

    public QDepositmasterlog(PathMetadata<?> metadata) {
        super(QDepositmasterlog.class, metadata, "null", "depositmasterlog");
    }

...
/**
 * NPAClassification_180Id entity. @author MyEclipse Persistence Tools
 */

public class NPAClassification_180Id  implements java.io.Serializable {
    ...
    /** default constructor */
    public NPAClassification_180Id() {
    }

    
    /** full constructor */
    public NPAClassification_180Id(Integer loanType, Integer daysLimitFr, Integer daysLimitTo, Integer mthsLimitFr, Integer mthsLimitTo, Integer assetCode, String assetDesc, Double provPerc, Date fromDate, Date toDate) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof NPAClassification_180Id) ) return false;
		 NPAClassification_180Id castOther = ( NPAClassification_180Id ) other; 

...
/**
 * NPAClassificationId entity. @author MyEclipse Persistence Tools
 */

public class NPAClassificationId  implements java.io.Serializable {
    ...
    /** default constructor */
    public NPAClassificationId() {
    }

    
    /** full constructor */
    public NPAClassificationId(Integer loanType, Integer daysLimitFr, Integer daysLimitTo, Integer mthsLimitFr, Integer mthsLimitTo, Integer assetCode, String assetDesc, Double provPerc, Date fromDate, Date toDate) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof NPAClassificationId) ) return false;
		 NPAClassificationId castOther = ( NPAClassificationId ) other; 

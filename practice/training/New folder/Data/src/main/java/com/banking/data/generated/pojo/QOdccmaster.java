...
/**
 * QOdccmaster is a Querydsl query type for QOdccmaster
 */
@Generated("com.mysema.query.sql.codegen.MetaDataSerializer")
public class QOdccmaster extends com.mysema.query.sql.RelationalPathBase<QOdccmaster> {

    private static final long serialVersionUID = -1030705812;

    public static final QOdccmaster odccmaster = new QOdccmaster("odccmaster");
    ...
    public final com.mysema.query.sql.PrimaryKey<QOdccmaster> primary = createPrimaryKey(acNo, acType);

    public QOdccmaster(String variable) {
        super(QOdccmaster.class, forVariable(variable), "null", "odccmaster");
    }

    @SuppressWarnings("all")
    public QOdccmaster(Path<? extends QOdccmaster> path) {
        super((Class)path.getType(), path.getMetadata(), "null", "odccmaster");
    }

    public QOdccmaster(PathMetadata<?> metadata) {
        super(QOdccmaster.class, metadata, "null", "odccmaster");
    }

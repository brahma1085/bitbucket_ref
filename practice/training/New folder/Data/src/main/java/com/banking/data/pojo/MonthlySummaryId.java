...
/**
 * MonthlySummaryId entity. @author MyEclipse Persistence Tools
 */

public class MonthlySummaryId  implements java.io.Serializable {
    ...
    /** full constructor */
    public MonthlySummaryId(Integer yrMth, String recordType, String glType, Integer glCode, Double cashDr, Double cgDr, Double trfDr, Double cashCr, Double cgCr, Double trfCr, String deTml, String deUser, Timestamp deDateTime, String veTml, String veUser, Timestamp veDateTime) {
        this.yrMth = yrMth;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof MonthlySummaryId) ) return false;
		 MonthlySummaryId castOther = ( MonthlySummaryId ) other; 

...
/**
 * RBIForm9TransactionId entity. @author MyEclipse Persistence Tools
 */

public class RBIForm9TransactionId  implements java.io.Serializable {
    ...
    /** default constructor */
    public RBIForm9TransactionId() {
    }

    
    /** full constructor */
    public RBIForm9TransactionId(Integer code, String trnSrc, String glType, Integer glCode, Date trnDate, Double closingBal, Integer sequence, String deTml, String deUser, Timestamp deDtTime) {
        this.code = code;
        this.trnSrc = trnSrc;
        this.glType = glType;
        this.glCode = glCode;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof RBIForm9TransactionId) ) return false;
		 RBIForm9TransactionId castOther = ( RBIForm9TransactionId ) other; 

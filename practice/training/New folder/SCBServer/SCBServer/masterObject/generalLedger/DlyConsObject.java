 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DlyConsObject  implements java.io.Serializable{

    int br_code,gl_code;
    String trn_dt,gl_type,de_tml,de_user,de_dt_tm,ve_tml,ve_user,ve_dt_tm;
    ...
    /**
     * @return Returns the trn_dt.
     */
    public String getTrn_dt() {
        return trn_dt;
    }
    /**
     * @param trn_dt The trn_dt to set.
     */
    ...
    /**
     * @return Returns the columns Name.
     */
    public String[] getColumns() {
        return columns;
    }
    /**
     * @param columns The columns name to set.
     */

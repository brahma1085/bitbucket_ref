...
import SRC.COM.SUNRISE.UTILITY.VALUEOBJECT.GoldObject;
import SRC.COM.SUNRISE.UTILITY.VALUEOBJECT.IncomeObject;
import SRC.COM.SUNRISE.UTILITY.VALUEOBJECT.PropertyObject;
import SRC.COM.SUNRISE.UTILITY.VALUEOBJECT.SignatureInstructionObject;
import SRC.COM.SUNRISE.UTILITY.VALUEOBJECT.VehicleObject;
...
{
	String lnactype,appndate,paymode,payacctype,sancdate,ldgprntdt,lsttrndt,clsdt,intuptodt,name,tdactype,scst,rel=null,shactype;
	int addrtype,holiday_period,prior;
	...
	public String getRemd_date(){return remd_date;}
	public void setRemd_date(String remd_date){this.remd_date=remd_date;}
	
	public int getRemd_no(){return remd_no;}
	public void setRemd_no(int remd_no){this.remd_no=remd_no;}
	public int getPrior() {
		return prior;
	}
